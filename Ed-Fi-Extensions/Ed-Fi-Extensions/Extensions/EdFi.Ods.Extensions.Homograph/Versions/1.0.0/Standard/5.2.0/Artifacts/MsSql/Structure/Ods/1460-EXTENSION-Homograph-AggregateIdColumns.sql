...
ALTER TABLE [homograph].[Contact] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[Contact_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[Name] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[Name_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[School] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[School_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[SchoolYearType] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[SchoolYearType_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[Staff] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[Staff_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[Student] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[Student_AggSeq], AggregateData varbinary(8000);
...
ALTER TABLE [homograph].[StudentSchoolAssociation] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [homograph].[StudentSchoolAssociation_AggSeq], AggregateData varbinary(8000);
