...
ALTER TABLE homograph.Parent ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
ALTER TABLE homograph.Parent ALTER COLUMN Id SET DEFAULT gen_random_uuid();
ALTER TABLE homograph.Parent ALTER COLUMN LastModifiedDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
CREATE TABLE homograph.ParentAddress (
    ...
    CreateDate TIMESTAMP NOT NULL,
    CONSTRAINT ParentAddress_PK PRIMARY KEY (ParentFirstName, ParentLastSurname, City)
);
ALTER TABLE homograph.ParentAddress ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
...
ALTER TABLE homograph.ParentStudentSchoolAssociation ALTER COLUMN CreateDate SET DEFAULT current_timestamp AT TIME ZONE 'UTC';
