...
BEGIN
	...
	WHERE ClaimName IN ('http://ed-fi.org/ods/identity/claims/tpdm/candidate','http://ed-fi.org/ods/identity/claims/person','http://ed-fi.org/ods/identity/claims/student',
					   'http://ed-fi.org/ods/identity/claims/studentSchoolAssociation','http://ed-fi.org/ods/identity/claims/credential','http://ed-fi.org/ods/identity/claims/domains/tpdm/candidatePreparation',
					   'http://ed-fi.org/ods/identity/claims/domains/tpdm/performanceEvaluation','http://ed-fi.org/ods/identity/claims/domains/tpdm/survey','http://ed-fi.org/ods/identity/claims/domains/surveyDomain',
