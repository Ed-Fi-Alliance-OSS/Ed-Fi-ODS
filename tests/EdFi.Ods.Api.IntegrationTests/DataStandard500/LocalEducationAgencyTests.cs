...
namespace EdFi.Ods.Api.IntegrationTests.DataStandard500
{
    ...
    public class LocalEducationAgencyTests : DatabaseTestFixtureBase
    {
        ...
        public void When_updating_local_education_agency_with_schools_and_without_education_service_center_to_with_education_service_center_should_update_tuples()
        {
            ...
            EducationOrganizationHelper.ShouldContainTuples<long, long>(Connection, (9001, 9001), (9001, 90010), (9001, 90011));

            Builder
                .UpdateLocalEducationAgency(9001, educationServiceCenterId: 900)
                .Execute();

            EducationOrganizationHelper.ShouldContainTuples<long, long>(Connection, (9001, 9001), (9001, 90010), (9001, 90011), (900, 9001), (900, 90010), (900, 90011));
        }
        ...
        public void When_inserting_and_deleting_local_education_agency_with_state_education_agency_should_update_tuples()
        {
            ...
            EducationOrganizationHelper.ShouldContainTuples<long, long>(Connection, (9001, 9001), (9, 9001));

            Builder
                .DeleteEducationOrganization(9001)
                .Execute();

            EducationOrganizationHelper.ShouldNotContainTuples<long, long>(Connection, (9001, 9001), (9, 9001));
        }
        ...
        public void When_updating_local_education_agency_without_state_education_agency_to_with_state_education_agency_should_update_tuples()
        {
            ...
            EducationOrganizationHelper.ShouldContainTuples<long, long>(Connection, (9001, 9001));
            EducationOrganizationHelper.ShouldNotContainTuples<long, long>(Connection, (9, 9001));
        ...
        public void When_updating_local_education_agency_with_state_education_agency_and_education_service_center_progressively_to_without_state_education_agency_or_education_service_center_should_update_tuples()
        {
            ...
            EducationOrganizationHelper.ShouldContainTuples<long, long>(
                Connection,
                (9, 9),
                (900, 900),
                (9001, 9001),
        ...
        public void When_updating_local_education_agency_with_parent_local_education_agencies_should_update_tuples()
        {
            ...
            EducationOrganizationHelper.ShouldContainTuples<long, long>(Connection,
                (9001, 9001),
                (9002, 9002),
                (9003, 9003),
                (90011, 90011),
            ...
            EducationOrganizationHelper.ShouldNotContainTuples<long, long>(
                Connection,
                (9002, 9001),
                (9002, 90011),
                (9002, 90012),
