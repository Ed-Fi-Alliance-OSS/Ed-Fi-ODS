...
namespace EdFi.Ods.Api.IntegrationTests.DataStandard500
{
    ...
    public class EducationOrganizationIdToStudentUSIThroughResponsibilityAuthViewTests : DatabaseTestFixtureBase
    {
        ...
        public void When_student_is_enrolled_in_school_that_belongs_to_a_district_should_not_return_duplicate_records()
        {
            ...
            AuthorizationViewHelper.HasDuplicateRecordsForAuthorizationView<long,int>(Connection, ViewName).ShouldBeFalse();
        }
            ...
            When_student_is_enrolled_in_a_school_through_StudentSchoolAssociation_should_not_have_access_from_that_school()
        {
            ...
            AuthorizationViewHelper.ShouldNotContainTuples<long,int>(Connection, ViewName, (9701, studentUsi));
        }
        ...
        public void When_student_is_enrolled_in_a_school_should_have_access_from_that_school()
        {
            ...
            AuthorizationViewHelper.ShouldContainTuples<long,int>(Connection, ViewName, (9701, studentUsi));
        }
        ...
        public void When_student_is_enrolled_in_one_school_should_not_have_access_from_other_school()
        {
            ...
            AuthorizationViewHelper.ShouldNotContainTuples<long,int>(Connection, ViewName, expectedTuples);
        }
        ...
        public void When_student_is_enrolled_in_multiple_schools_should_have_access_from_those_schools()
        {
            ...
            AuthorizationViewHelper.ShouldContainTuples<long, int>(Connection, ViewName, expectedTuples);
        }
