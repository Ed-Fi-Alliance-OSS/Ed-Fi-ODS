        ...
        private void RunCliCodegen(IEnumerable<OpenApiDetail> apiEndpoints)
        {
            foreach (var apiEndpoint in apiEndpoints)
            {
                ...
                string[] @params =
                {
                    ...
                    "--global-property modelTests=false --global-property apiTests=false --global-property apiDocs=false --global-property modelDocs=false --skip-validate-spec --reserved-words-mappings=namespace=_namespace"
                };
