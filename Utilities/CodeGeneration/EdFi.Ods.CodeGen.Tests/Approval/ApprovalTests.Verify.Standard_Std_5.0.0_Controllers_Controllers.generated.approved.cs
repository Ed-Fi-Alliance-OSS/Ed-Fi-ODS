...
namespace EdFi.Ods.Api.Services.Controllers.EnrollmentTypeDescriptors.EdFi
{
    ...
    [ApiController]
    [Authorize]
    [RouteRootContext(RouteContextType.Ods), Route($"{RouteConstants.DataManagementRoutePrefix}/ed-fi/enrollmentTypeDescriptors")]
...
namespace EdFi.Ods.Api.Services.Controllers.SchoolChoiceBasisDescriptors.EdFi
{
    ...
    [ApiController]
    [Authorize]
    [RouteRootContext(RouteContextType.Ods), Route($"{RouteConstants.DataManagementRoutePrefix}/ed-fi/schoolChoiceBasisDescriptors")]
