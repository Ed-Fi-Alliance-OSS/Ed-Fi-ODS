...
namespace EdFi.Ods.Entities.Common.Sample //.BusRouteAggregate
{
    ...
    public static class BusRouteMapper
    {
            ...
            if (mappingContract?.IsBusRouteBusYearsSupported ?? true)
            {
                isModified |=
                    source.BusRouteBusYears.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsBusRouteBusYearsItemCreatable ?? true,
            ...
            if (mappingContract?.IsBusRouteProgramsSupported ?? true)
            {
                isModified |=
                    source.BusRoutePrograms.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsBusRouteProgramsItemCreatable ?? true,
            ...
            if (mappingContract?.IsBusRouteServiceAreaPostalCodesSupported ?? true)
            {
                isModified |=
                    source.BusRouteServiceAreaPostalCodes.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsBusRouteServiceAreaPostalCodesItemCreatable ?? true,
            ...
            if (mappingContract?.IsBusRouteStartTimesSupported ?? true)
            {
                isModified |=
                    source.BusRouteStartTimes.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsBusRouteStartTimesItemCreatable ?? true,
            ...
            if (mappingContract?.IsBusRouteTelephonesSupported ?? true)
            {
                isModified |=
                    source.BusRouteTelephones.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsBusRouteTelephonesItemCreatable ?? true,
        ...
        public static void MapTo(this IBusRoute source, IBusRoute target, Action<IBusRoute, IBusRoute> onMapped)
        {
            ...
            {
                source.BusRouteBusYears.MapCollectionTo(target.BusRouteBusYears, mappingContract?.IsBusRouteBusYearsItemCreatable ?? true, target, mappingContract?.IsBusRouteBusYearIncluded);
            }

            if (mappingContract?.IsBusRouteProgramsSupported != false)
            {
                source.BusRoutePrograms.MapCollectionTo(target.BusRoutePrograms, mappingContract?.IsBusRouteProgramsItemCreatable ?? true, target, mappingContract?.IsBusRouteProgramIncluded);
            }

            if (mappingContract?.IsBusRouteServiceAreaPostalCodesSupported != false)
            {
                source.BusRouteServiceAreaPostalCodes.MapCollectionTo(target.BusRouteServiceAreaPostalCodes, mappingContract?.IsBusRouteServiceAreaPostalCodesItemCreatable ?? true, target, mappingContract?.IsBusRouteServiceAreaPostalCodeIncluded);
            }

            if (mappingContract?.IsBusRouteStartTimesSupported != false)
            {
                source.BusRouteStartTimes.MapCollectionTo(target.BusRouteStartTimes, mappingContract?.IsBusRouteStartTimesItemCreatable ?? true, target, mappingContract?.IsBusRouteStartTimeIncluded);
            }

            if (mappingContract?.IsBusRouteTelephonesSupported != false)
            {
                source.BusRouteTelephones.MapCollectionTo(target.BusRouteTelephones, mappingContract?.IsBusRouteTelephonesItemCreatable ?? true, target, mappingContract?.IsBusRouteTelephoneIncluded);
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.ContactAggregate
{
    ...
    public static class ContactAddressExtensionMapper
    {
            ...
            if (mappingContract?.IsContactAddressSchoolDistrictsSupported ?? true)
            {
                isModified |=
                    source.ContactAddressSchoolDistricts.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactAddressSchoolDistrictsItemCreatable ?? true,
            ...
            if (mappingContract?.IsContactAddressTermsSupported ?? true)
            {
                isModified |=
                    source.ContactAddressTerms.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactAddressTermsItemCreatable ?? true,
        ...
        public static void MapTo(this IContactAddressExtension source, IContactAddressExtension target, Action<IContactAddressExtension, IContactAddressExtension> onMapped)
        {
            ...
            {
                source.ContactAddressSchoolDistricts.MapCollectionTo(target.ContactAddressSchoolDistricts, mappingContract?.IsContactAddressSchoolDistrictsItemCreatable ?? true, target.ContactAddress, mappingContract?.IsContactAddressSchoolDistrictIncluded);
            }

            if (mappingContract?.IsContactAddressTermsSupported != false)
            {
                source.ContactAddressTerms.MapCollectionTo(target.ContactAddressTerms, mappingContract?.IsContactAddressTermsItemCreatable ?? true, target.ContactAddress, mappingContract?.IsContactAddressTermIncluded);
            }
    ...
    [ExcludeFromCodeCoverage]
    public static class ContactCTEProgramServiceMapper
    {
        private static readonly FullName _fullName_sample_ContactCTEProgramService = new FullName("sample", "ContactCTEProgramService");
    
        public static bool SynchronizeTo(this IContactCTEProgramService source, IContactCTEProgramService target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (ContactCTEProgramServiceMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_sample_ContactCTEProgramService);
        ...
        public static void MapTo(this IContactCTEProgramService source, IContactCTEProgramService target, Action<IContactCTEProgramService, IContactCTEProgramService> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (ContactCTEProgramServiceMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
    ...
    public static class ContactEducationContentMapper
    {
        ...
        public static bool SynchronizeTo(this IContactEducationContent source, IContactEducationContent target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.EducationContentResourceId == null)
                {
                    target.EducationContentResourceId = null;
                }
            }
    ...
    public static class ContactExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IContactExtension source, IContactExtension target)
        {
            ...
            // ----------------------------------
            // ContactCTEProgramService (ContactCTEProgramService)
            if (mappingContract?.IsContactCTEProgramServiceSupported != false)
            {
                if (source.ContactCTEProgramService == null)
                {
                    if (target.ContactCTEProgramService != null)
                    {
                        target.ContactCTEProgramService = null;
                        isModified = true;
                    }
                }
                else
                {
                    if (target.ContactCTEProgramService == null)
                    {
                        var itemType = target.GetType().GetProperty("ContactCTEProgramService").PropertyType;
            
                        if (!(mappingContract?.IsContactCTEProgramServiceCreatable ?? true))
                        {
                        ...
                        target.ContactCTEProgramService = (IContactCTEProgramService) newItem;
                    }

                    isModified |= source.ContactCTEProgramService.Synchronize(target.ContactCTEProgramService);
                }
            }
            ...
            if (mappingContract?.IsContactTeacherConferenceSupported != false)
            {
                ...
                else
                {
                    if (target.ContactTeacherConference == null)
                    {
                        ...
                        if (!(mappingContract?.IsContactTeacherConferenceCreatable ?? true))
                        {
                            string profileName = GeneratedArtifactStaticDependencies.ProfileContentTypeContextProvider.Get().ProfileName;
            ...
            if (mappingContract?.IsContactAuthorsSupported ?? true)
            {
                isModified |=
                    source.ContactAuthors.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactAuthorsItemCreatable ?? true,
            ...
            if (mappingContract?.IsContactCeilingHeightsSupported ?? true)
            {
                isModified |=
                    source.ContactCeilingHeights.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactCeilingHeightsItemCreatable ?? true,
            ...
            if (mappingContract?.IsContactEducationContentsSupported ?? true)
            {
                isModified |=
                    source.ContactEducationContents.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactEducationContentsItemCreatable ?? true,
            ...
            if (mappingContract?.IsContactFavoriteBookTitlesSupported ?? true)
            {
                isModified |=
                    source.ContactFavoriteBookTitles.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactFavoriteBookTitlesItemCreatable ?? true,
            ...
            if (mappingContract?.IsContactStudentProgramAssociationsSupported ?? true)
            {
                isModified |=
                    source.ContactStudentProgramAssociations.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsContactStudentProgramAssociationsItemCreatable ?? true,
        ...
        public static void MapTo(this IContactExtension source, IContactExtension target, Action<IContactExtension, IContactExtension> onMapped)
        {
            ...
            //   Map One-to-one relationships
            // ----------------------------------
            // ContactCTEProgramService (ContactCTEProgramService) (Source)
            if (mappingContract?.IsContactCTEProgramServiceSupported != false)
            {
                var itemProperty = target.GetType().GetProperty("ContactCTEProgramService");
                ...
                if (itemProperty != null)
                {
                    ...
                    else
                    {
                        ...
                        object targetContactCTEProgramService = Activator.CreateInstance(itemType);
                        (targetContactCTEProgramService as IChildEntity)?.SetParent(target.Contact);
                        source.ContactCTEProgramService.Map(targetContactCTEProgramService);

                        // Update the target reference appropriately
                        target.ContactCTEProgramService = (IContactCTEProgramService) targetContactCTEProgramService;
                    }
                }
            }
            ...
            {
                source.ContactAuthors.MapCollectionTo(target.ContactAuthors, mappingContract?.IsContactAuthorsItemCreatable ?? true, target.Contact, mappingContract?.IsContactAuthorIncluded);
            }

            if (mappingContract?.IsContactCeilingHeightsSupported != false)
            {
                source.ContactCeilingHeights.MapCollectionTo(target.ContactCeilingHeights, mappingContract?.IsContactCeilingHeightsItemCreatable ?? true, target.Contact, mappingContract?.IsContactCeilingHeightIncluded);
            }

            if (mappingContract?.IsContactEducationContentsSupported != false)
            {
                source.ContactEducationContents.MapCollectionTo(target.ContactEducationContents, mappingContract?.IsContactEducationContentsItemCreatable ?? true, target.Contact, mappingContract?.IsContactEducationContentIncluded);
            }

            if (mappingContract?.IsContactFavoriteBookTitlesSupported != false)
            {
                source.ContactFavoriteBookTitles.MapCollectionTo(target.ContactFavoriteBookTitles, mappingContract?.IsContactFavoriteBookTitlesItemCreatable ?? true, target.Contact, mappingContract?.IsContactFavoriteBookTitleIncluded);
            }

            if (mappingContract?.IsContactStudentProgramAssociationsSupported != false)
            {
                source.ContactStudentProgramAssociations.MapCollectionTo(target.ContactStudentProgramAssociations, mappingContract?.IsContactStudentProgramAssociationsItemCreatable ?? true, target.Contact, mappingContract?.IsContactStudentProgramAssociationIncluded);
            }
    ...
    public static class ContactStudentProgramAssociationMapper
    {
        ...
        public static bool SynchronizeTo(this IContactStudentProgramAssociation source, IContactStudentProgramAssociation target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.StudentProgramAssociationResourceId == null)
                {
                    target.StudentProgramAssociationResourceId = null;
                }
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.SchoolAggregate
{
    ...
    public static class SchoolDirectlyOwnedBusMapper
    {
        ...
        public static bool SynchronizeTo(this ISchoolDirectlyOwnedBus source, ISchoolDirectlyOwnedBus target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.DirectlyOwnedBusResourceId == null)
                {
                    target.DirectlyOwnedBusResourceId = null;
                }
            }
    ...
    public static class SchoolExtensionMapper
    {
            ...
            if (mappingContract?.IsSchoolDirectlyOwnedBusesSupported ?? true)
            {
                isModified |=
                    source.SchoolDirectlyOwnedBuses.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsSchoolDirectlyOwnedBusesItemCreatable ?? true,
        ...
        public static void MapTo(this ISchoolExtension source, ISchoolExtension target, Action<ISchoolExtension, ISchoolExtension> onMapped)
        {
            ...
            {
                source.SchoolDirectlyOwnedBuses.MapCollectionTo(target.SchoolDirectlyOwnedBuses, mappingContract?.IsSchoolDirectlyOwnedBusesItemCreatable ?? true, target.School, mappingContract?.IsSchoolDirectlyOwnedBusIncluded);
            }
            ...
            if (mappingContract?.IsStaffPetsSupported ?? true)
            {
                isModified |=
                    source.StaffPets.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStaffPetsItemCreatable ?? true,
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentAggregate
{
    ...
    public static class StudentExtensionMapper
    {
            ...
            if (mappingContract?.IsStudentAquaticPetsSupported ?? true)
            {
                isModified |=
                    source.StudentAquaticPets.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentAquaticPetsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentFavoriteBooksSupported ?? true)
            {
                isModified |=
                    source.StudentFavoriteBooks.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentFavoriteBooksItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentPetsSupported ?? true)
            {
                isModified |=
                    source.StudentPets.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentPetsItemCreatable ?? true,
        ...
        public static void MapTo(this IStudentExtension source, IStudentExtension target, Action<IStudentExtension, IStudentExtension> onMapped)
        {
            ...
            {
                source.StudentAquaticPets.MapCollectionTo(target.StudentAquaticPets, mappingContract?.IsStudentAquaticPetsItemCreatable ?? true, target.Student, mappingContract?.IsStudentAquaticPetIncluded);
            }
            ...
            {
                source.StudentPets.MapCollectionTo(target.StudentPets, mappingContract?.IsStudentPetsItemCreatable ?? true, target.Student, mappingContract?.IsStudentPetIncluded);
            }
    ...
    public static class StudentFavoriteBookMapper
    {
            ...
            if (mappingContract?.IsStudentFavoriteBookArtMediaSupported ?? true)
            {
                isModified |=
                    source.StudentFavoriteBookArtMedia.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentFavoriteBookArtMediaItemCreatable ?? true,
        ...
        public static void MapTo(this IStudentFavoriteBook source, IStudentFavoriteBook target, Action<IStudentFavoriteBook, IStudentFavoriteBook> onMapped)
        {
            ...
            {
                source.StudentFavoriteBookArtMedia.MapCollectionTo(target.StudentFavoriteBookArtMedia, mappingContract?.IsStudentFavoriteBookArtMediaItemCreatable ?? true, target, mappingContract?.IsStudentFavoriteBookArtMediumIncluded);
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentArtProgramAssociationAggregate
{
    ...
    public static class StudentArtProgramAssociationMapper
    {
            ...
            if (mappingContract?.IsStudentArtProgramAssociationArtMediaSupported ?? true)
            {
                isModified |=
                    source.StudentArtProgramAssociationArtMedia.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentArtProgramAssociationArtMediaItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentArtProgramAssociationPortfolioYearsSupported ?? true)
            {
                isModified |=
                    source.StudentArtProgramAssociationPortfolioYears.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentArtProgramAssociationPortfolioYearsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentArtProgramAssociationServicesSupported ?? true)
            {
                isModified |=
                    source.StudentArtProgramAssociationServices.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentArtProgramAssociationServicesItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentArtProgramAssociationStylesSupported ?? true)
            {
                isModified |=
                    source.StudentArtProgramAssociationStyles.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentArtProgramAssociationStylesItemCreatable ?? true,
        ...
        public static void MapDerivedTo(this IStudentArtProgramAssociation source, IStudentArtProgramAssociation target, Action<IStudentArtProgramAssociation, IStudentArtProgramAssociation> onMapped)
        {
            ...
            {
                source.StudentArtProgramAssociationPortfolioYears.MapCollectionTo(target.StudentArtProgramAssociationPortfolioYears, mappingContract?.IsStudentArtProgramAssociationPortfolioYearsItemCreatable ?? true, target, mappingContract?.IsStudentArtProgramAssociationPortfolioYearsIncluded);
            }

            if (mappingContract?.IsStudentArtProgramAssociationServicesSupported != false)
            {
                source.StudentArtProgramAssociationServices.MapCollectionTo(target.StudentArtProgramAssociationServices, mappingContract?.IsStudentArtProgramAssociationServicesItemCreatable ?? true, target, mappingContract?.IsStudentArtProgramAssociationServiceIncluded);
            }

            if (mappingContract?.IsStudentArtProgramAssociationStylesSupported != false)
            {
                source.StudentArtProgramAssociationStyles.MapCollectionTo(target.StudentArtProgramAssociationStyles, mappingContract?.IsStudentArtProgramAssociationStylesItemCreatable ?? true, target, mappingContract?.IsStudentArtProgramAssociationStyleIncluded);
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentContactAssociationAggregate
{
    ...
    public static class StudentContactAssociationExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentContactAssociationExtension source, IStudentContactAssociationExtension target)
        {
            ...
            if (mappingContract?.IsStudentContactAssociationTelephoneSupported != false)
            {
                ...
                else
                {
                    if (target.StudentContactAssociationTelephone == null)
                    {
                        ...
                        if (!(mappingContract?.IsStudentContactAssociationTelephoneCreatable ?? true))
                        {
                            string profileName = GeneratedArtifactStaticDependencies.ProfileContentTypeContextProvider.Get().ProfileName;
            ...
            if (mappingContract?.IsStudentContactAssociationDisciplinesSupported ?? true)
            {
                isModified |=
                    source.StudentContactAssociationDisciplines.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentContactAssociationDisciplinesItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentContactAssociationFavoriteBookTitlesSupported ?? true)
            {
                isModified |=
                    source.StudentContactAssociationFavoriteBookTitles.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentContactAssociationFavoriteBookTitlesItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentContactAssociationHoursPerWeeksSupported ?? true)
            {
                isModified |=
                    source.StudentContactAssociationHoursPerWeeks.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentContactAssociationHoursPerWeeksItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentContactAssociationPagesReadsSupported ?? true)
            {
                isModified |=
                    source.StudentContactAssociationPagesReads.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentContactAssociationPagesReadsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentContactAssociationStaffEducationOrganizationEmploymentAssociationsSupported ?? true)
            {
                isModified |=
                    source.StudentContactAssociationStaffEducationOrganizationEmploymentAssociations.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentContactAssociationStaffEducationOrganizationEmploymentAssociationsItemCreatable ?? true,
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.InterventionStudyResourceId == null)
                {
                    target.InterventionStudyResourceId = null;
                }
            }
        ...
        public static void MapTo(this IStudentContactAssociationExtension source, IStudentContactAssociationExtension target, Action<IStudentContactAssociationExtension, IStudentContactAssociationExtension> onMapped)
        {
            ...
            {
                source.StudentContactAssociationFavoriteBookTitles.MapCollectionTo(target.StudentContactAssociationFavoriteBookTitles, mappingContract?.IsStudentContactAssociationFavoriteBookTitlesItemCreatable ?? true, target.StudentContactAssociation, mappingContract?.IsStudentContactAssociationFavoriteBookTitleIncluded);
            }

            if (mappingContract?.IsStudentContactAssociationHoursPerWeeksSupported != false)
            {
                source.StudentContactAssociationHoursPerWeeks.MapCollectionTo(target.StudentContactAssociationHoursPerWeeks, mappingContract?.IsStudentContactAssociationHoursPerWeeksItemCreatable ?? true, target.StudentContactAssociation, mappingContract?.IsStudentContactAssociationHoursPerWeekIncluded);
            }

            if (mappingContract?.IsStudentContactAssociationPagesReadsSupported != false)
            {
                source.StudentContactAssociationPagesReads.MapCollectionTo(target.StudentContactAssociationPagesReads, mappingContract?.IsStudentContactAssociationPagesReadsItemCreatable ?? true, target.StudentContactAssociation, mappingContract?.IsStudentContactAssociationPagesReadIncluded);
            }

            if (mappingContract?.IsStudentContactAssociationStaffEducationOrganizationEmploymentAssociationsSupported != false)
            {
                source.StudentContactAssociationStaffEducationOrganizationEmploymentAssociations.MapCollectionTo(target.StudentContactAssociationStaffEducationOrganizationEmploymentAssociations, mappingContract?.IsStudentContactAssociationStaffEducationOrganizationEmploymentAssociationsItemCreatable ?? true, target.StudentContactAssociation, mappingContract?.IsStudentContactAssociationStaffEducationOrganizationEmploymentAssociationIncluded);
            }
    ...
    public static class StudentContactAssociationStaffEducationOrganizationEmploymentAssociationMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentContactAssociationStaffEducationOrganizationEmploymentAssociation source, IStudentContactAssociationStaffEducationOrganizationEmploymentAssociation target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.StaffEducationOrganizationEmploymentAssociationResourceId == null)
                {
                    target.StaffEducationOrganizationEmploymentAssociationResourceId = null;
                }
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentDemographicAggregate
{
    [ExcludeFromCodeCoverage]
    public static class StudentDemographicStudentCharacteristicExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentDemographicStudentCharacteristicExtension source, IStudentDemographicStudentCharacteristicExtension target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentDemographicStudentCharacteristicExtensionMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            // Sync lists
            if (mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedsSupported ?? true)
            {
                isModified |=
                    source.StudentDemographicStudentCharacteristicStudentNeeds.SynchronizeCollectionTo(
                        target.StudentDemographicStudentCharacteristicStudentNeeds,
                        onChildAdded: child =>
                            {
                                child.StudentDemographicStudentCharacteristicExtension = target;

                                // Extension class "children" need to reference the Ed-Fi Standard entity as the parent
                                (child as IChildEntity)?.SetParent(target.StudentDemographicStudentCharacteristic);
                            },
                        itemCreatable: mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedsItemCreatable ?? true,
                        includeItem: item => mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedIncluded?.Invoke(item) ?? true);
            }
        ...
        public static void MapTo(this IStudentDemographicStudentCharacteristicExtension source, IStudentDemographicStudentCharacteristicExtension target, Action<IStudentDemographicStudentCharacteristicExtension, IStudentDemographicStudentCharacteristicExtension> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentDemographicStudentCharacteristicExtensionMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            if (mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedsSupported != false)
            {
                source.StudentDemographicStudentCharacteristicStudentNeeds.MapCollectionTo(target.StudentDemographicStudentCharacteristicStudentNeeds, mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedsItemCreatable ?? true, target.StudentDemographicStudentCharacteristic, mappingContract?.IsStudentDemographicStudentCharacteristicStudentNeedIncluded);
            }
    ...
    [ExcludeFromCodeCoverage]
    public static class StudentDemographicStudentCharacteristicStudentNeedMapper
    {
        private static readonly FullName _fullName_sample_StudentDemographicStudentCharacteristicStudentNeed = new FullName("sample", "StudentDemographicStudentCharacteristicStudentNeed");
    
        public static bool SynchronizeTo(this IStudentDemographicStudentCharacteristicStudentNeed source, IStudentDemographicStudentCharacteristicStudentNeed target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentDemographicStudentCharacteristicStudentNeedMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_sample_StudentDemographicStudentCharacteristicStudentNeed);
        ...
        public static void MapTo(this IStudentDemographicStudentCharacteristicStudentNeed source, IStudentDemographicStudentCharacteristicStudentNeed target, Action<IStudentDemographicStudentCharacteristicStudentNeed, IStudentDemographicStudentCharacteristicStudentNeed> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentDemographicStudentCharacteristicStudentNeedMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentDirectoryAggregate
{
    [ExcludeFromCodeCoverage]
    public static class StudentDirectoryAddressExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentDirectoryAddressExtension source, IStudentDirectoryAddressExtension target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentDirectoryAddressExtensionMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            // Sync lists
            if (mappingContract?.IsStudentDirectoryAddressSchoolDistrictsSupported ?? true)
            {
                isModified |=
                    source.StudentDirectoryAddressSchoolDistricts.SynchronizeCollectionTo(
                        target.StudentDirectoryAddressSchoolDistricts,
                        onChildAdded: child =>
                            {
                                child.StudentDirectoryAddressExtension = target;

                                // Extension class "children" need to reference the Ed-Fi Standard entity as the parent
                                (child as IChildEntity)?.SetParent(target.StudentDirectoryAddress);
                            },
                        itemCreatable: mappingContract?.IsStudentDirectoryAddressSchoolDistrictsItemCreatable ?? true,
                        includeItem: item => mappingContract?.IsStudentDirectoryAddressSchoolDistrictIncluded?.Invoke(item) ?? true);
            }

            if (mappingContract?.IsStudentDirectoryAddressTermsSupported ?? true)
            {
                isModified |=
                    source.StudentDirectoryAddressTerms.SynchronizeCollectionTo(
                        target.StudentDirectoryAddressTerms,
                        onChildAdded: child =>
                            {
                                child.StudentDirectoryAddressExtension = target;
                        ...
                        itemCreatable: mappingContract?.IsStudentDirectoryAddressTermsItemCreatable ?? true,
                        includeItem: item => mappingContract?.IsStudentDirectoryAddressTermIncluded?.Invoke(item) ?? true);
            }
        ...
        public static void MapTo(this IStudentDirectoryAddressExtension source, IStudentDirectoryAddressExtension target, Action<IStudentDirectoryAddressExtension, IStudentDirectoryAddressExtension> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentDirectoryAddressExtensionMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
            ...
            if (mappingContract?.IsStudentDirectoryAddressSchoolDistrictsSupported != false)
            {
                source.StudentDirectoryAddressSchoolDistricts.MapCollectionTo(target.StudentDirectoryAddressSchoolDistricts, mappingContract?.IsStudentDirectoryAddressSchoolDistrictsItemCreatable ?? true, target.StudentDirectoryAddress, mappingContract?.IsStudentDirectoryAddressSchoolDistrictIncluded);
            }

            if (mappingContract?.IsStudentDirectoryAddressTermsSupported != false)
            {
                source.StudentDirectoryAddressTerms.MapCollectionTo(target.StudentDirectoryAddressTerms, mappingContract?.IsStudentDirectoryAddressTermsItemCreatable ?? true, target.StudentDirectoryAddress, mappingContract?.IsStudentDirectoryAddressTermIncluded);
            }
    ...
    [ExcludeFromCodeCoverage]
    public static class StudentDirectoryAddressSchoolDistrictMapper
    {
        private static readonly FullName _fullName_sample_StudentDirectoryAddressSchoolDistrict = new FullName("sample", "StudentDirectoryAddressSchoolDistrict");
    
        public static bool SynchronizeTo(this IStudentDirectoryAddressSchoolDistrict source, IStudentDirectoryAddressSchoolDistrict target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentDirectoryAddressSchoolDistrictMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_sample_StudentDirectoryAddressSchoolDistrict);
        ...
        public static void MapTo(this IStudentDirectoryAddressSchoolDistrict source, IStudentDirectoryAddressSchoolDistrict target, Action<IStudentDirectoryAddressSchoolDistrict, IStudentDirectoryAddressSchoolDistrict> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentDirectoryAddressSchoolDistrictMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
    ...
    [ExcludeFromCodeCoverage]
    public static class StudentDirectoryAddressTermMapper
    {
        private static readonly FullName _fullName_sample_StudentDirectoryAddressTerm = new FullName("sample", "StudentDirectoryAddressTerm");
    
        public static bool SynchronizeTo(this IStudentDirectoryAddressTerm source, IStudentDirectoryAddressTerm target)
        {
            bool isModified = false;

            // Get the mapping contract for knowing what values to synchronize through to target entity
            var mappingContract = (StudentDirectoryAddressTermMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
                .GetMappingContract(_fullName_sample_StudentDirectoryAddressTerm);
        ...
        public static void MapTo(this IStudentDirectoryAddressTerm source, IStudentDirectoryAddressTerm target, Action<IStudentDirectoryAddressTerm, IStudentDirectoryAddressTerm> onMapped)
        {
            // Get the mapping contract for determining what values to map through to target
            var mappingContract = (StudentDirectoryAddressTermMappingContract) GeneratedArtifactStaticDependencies
                .MappingContractProvider
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentEducationOrganizationAssociationAggregate
{
    ...
    public static class StudentEducationOrganizationAssociationExtensionMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentEducationOrganizationAssociationExtension source, IStudentEducationOrganizationAssociationExtension target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.FavoriteProgramResourceId == null)
                {
                    target.FavoriteProgramResourceId = null;
                }
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentGraduationPlanAssociationAggregate
{
    ...
    public static class StudentGraduationPlanAssociationMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentGraduationPlanAssociation source, IStudentGraduationPlanAssociation target)
        {
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationAcademicSubjectsSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationAcademicSubjects.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationAcademicSubjectsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationCareerPathwayCodesSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationCareerPathwayCodes.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationCareerPathwayCodesItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationDescriptionsSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationDescriptions.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationDescriptionsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationDesignatedBiesSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationDesignatedBies.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationDesignatedBiesItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationIndustryCredentialsSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationIndustryCredentials.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationIndustryCredentialsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationStudentContactAssociationsSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationStudentContactAssociations.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationStudentContactAssociationsItemCreatable ?? true,
            ...
            if (mappingContract?.IsStudentGraduationPlanAssociationYearsAttendedsSupported ?? true)
            {
                isModified |=
                    source.StudentGraduationPlanAssociationYearsAttendeds.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentGraduationPlanAssociationYearsAttendedsItemCreatable ?? true,
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.GraduationPlanResourceId == null)
                {
                    target.GraduationPlanResourceId = null;
                }
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.StaffResourceId == null)
                {
                    target.StaffResourceId = null;
                }
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.StudentResourceId == null)
                {
        ...
        public static void MapTo(this IStudentGraduationPlanAssociation source, IStudentGraduationPlanAssociation target, Action<IStudentGraduationPlanAssociation, IStudentGraduationPlanAssociation> onMapped)
        {
            ...
            {
                source.StudentGraduationPlanAssociationAcademicSubjects.MapCollectionTo(target.StudentGraduationPlanAssociationAcademicSubjects, mappingContract?.IsStudentGraduationPlanAssociationAcademicSubjectsItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationAcademicSubjectIncluded);
            }

            if (mappingContract?.IsStudentGraduationPlanAssociationCareerPathwayCodesSupported != false)
            {
                source.StudentGraduationPlanAssociationCareerPathwayCodes.MapCollectionTo(target.StudentGraduationPlanAssociationCareerPathwayCodes, mappingContract?.IsStudentGraduationPlanAssociationCareerPathwayCodesItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationCareerPathwayCodeIncluded);
            }

            if (mappingContract?.IsStudentGraduationPlanAssociationDescriptionsSupported != false)
            {
                source.StudentGraduationPlanAssociationDescriptions.MapCollectionTo(target.StudentGraduationPlanAssociationDescriptions, mappingContract?.IsStudentGraduationPlanAssociationDescriptionsItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationDescriptionIncluded);
            }

            if (mappingContract?.IsStudentGraduationPlanAssociationDesignatedBiesSupported != false)
            {
                source.StudentGraduationPlanAssociationDesignatedBies.MapCollectionTo(target.StudentGraduationPlanAssociationDesignatedBies, mappingContract?.IsStudentGraduationPlanAssociationDesignatedBiesItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationDesignatedByIncluded);
            }
            ...
            {
                source.StudentGraduationPlanAssociationStudentContactAssociations.MapCollectionTo(target.StudentGraduationPlanAssociationStudentContactAssociations, mappingContract?.IsStudentGraduationPlanAssociationStudentContactAssociationsItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationStudentContactAssociationIncluded);
            }

            if (mappingContract?.IsStudentGraduationPlanAssociationYearsAttendedsSupported != false)
            {
                source.StudentGraduationPlanAssociationYearsAttendeds.MapCollectionTo(target.StudentGraduationPlanAssociationYearsAttendeds, mappingContract?.IsStudentGraduationPlanAssociationYearsAttendedsItemCreatable ?? true, target, mappingContract?.IsStudentGraduationPlanAssociationYearsAttendedIncluded);
            }
    ...
    public static class StudentGraduationPlanAssociationStudentContactAssociationMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentGraduationPlanAssociationStudentContactAssociation source, IStudentGraduationPlanAssociationStudentContactAssociation target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.StudentContactAssociationResourceId == null)
                {
                    target.StudentContactAssociationResourceId = null;
                }
            }
...
namespace EdFi.Ods.Entities.Common.Sample //.StudentSectionAssociationAggregate
{
    ...
    public static class StudentSectionAssociationExtensionMapper
    {
            ...
            if (mappingContract?.IsStudentSectionAssociationRelatedGeneralStudentProgramAssociationsSupported ?? true)
            {
                isModified |=
                    source.StudentSectionAssociationRelatedGeneralStudentProgramAssociations.SynchronizeCollectionTo(
                        ...
                        itemCreatable: mappingContract?.IsStudentSectionAssociationRelatedGeneralStudentProgramAssociationsItemCreatable ?? true,
        ...
        public static void MapTo(this IStudentSectionAssociationExtension source, IStudentSectionAssociationExtension target, Action<IStudentSectionAssociationExtension, IStudentSectionAssociationExtension> onMapped)
        {
            ...
            {
                source.StudentSectionAssociationRelatedGeneralStudentProgramAssociations.MapCollectionTo(target.StudentSectionAssociationRelatedGeneralStudentProgramAssociations, mappingContract?.IsStudentSectionAssociationRelatedGeneralStudentProgramAssociationsItemCreatable ?? true, target.StudentSectionAssociation, mappingContract?.IsStudentSectionAssociationRelatedGeneralStudentProgramAssociationIncluded);
            }
    ...
    public static class StudentSectionAssociationRelatedGeneralStudentProgramAssociationMapper
    {
        ...
        public static bool SynchronizeTo(this IStudentSectionAssociationRelatedGeneralStudentProgramAssociation source, IStudentSectionAssociationRelatedGeneralStudentProgramAssociation target)
        {
            ...
            {
                // Detect an uninitialized Id and invoke the setter so that it is added to the reference data resolution context
                if (target.RelatedGeneralStudentProgramAssociationResourceId == null)
                {
                    target.RelatedGeneralStudentProgramAssociationResourceId = null;
                }
            }
