...
namespace EdFi.Ods.CodeGen.Tests.Approval_Tests
{
    ...
    public class DataStanadard_500_ApprovalTests
    {
        ...
        private static List<ApprovalFileInfo> GetApprovalFileInfos()
        {
            var generatedFileList = Path.Combine(
                _odsRepository,
                "Utilities", "CodeGeneration", "EdFi.Ods.CodeGen.Tests", "Approval", StandardVersion, $"{nameof(DataStanadard_500_ApprovalTests)}.{nameof(Generated_File_List)}.Standard.{StandardVersion}.approved.txt");
                ...
                switch (ext.ToLower())
                {
                    ...
                    case ".sql":
                        ...
                        string destFileName = Path.Combine(
                            ...
                            , $"{nameof(DataStanadard_500_ApprovalTests)}.Verify.{file.Scenario}.approved{ext}");
