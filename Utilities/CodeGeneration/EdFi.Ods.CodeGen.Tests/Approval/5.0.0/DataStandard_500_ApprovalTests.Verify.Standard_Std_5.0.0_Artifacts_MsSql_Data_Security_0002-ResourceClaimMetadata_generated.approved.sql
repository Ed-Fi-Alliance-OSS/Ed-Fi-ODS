...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/contact' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'contact', N'contact', N'http://ed-fi.org/ods/identity/claims/contact',
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/eligibilityDelayReasonDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'eligibilityDelayReasonDescriptor', N'eligibilityDelayReasonDescriptor', N'http://ed-fi.org/ods/identity/claims/eligibilityDelayReasonDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);

END

IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/eligibilityEvaluationTypeDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'eligibilityEvaluationTypeDescriptor', N'eligibilityEvaluationTypeDescriptor', N'http://ed-fi.org/ods/identity/claims/eligibilityEvaluationTypeDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/enrollmentTypeDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'enrollmentTypeDescriptor', N'enrollmentTypeDescriptor', N'http://ed-fi.org/ods/identity/claims/enrollmentTypeDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/evaluationDelayReasonDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'evaluationDelayReasonDescriptor', N'evaluationDelayReasonDescriptor', N'http://ed-fi.org/ods/identity/claims/evaluationDelayReasonDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/ideaPartDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'ideaPartDescriptor', N'ideaPartDescriptor', N'http://ed-fi.org/ods/identity/claims/ideaPartDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/programEvaluationPeriodDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'programEvaluationPeriodDescriptor', N'programEvaluationPeriodDescriptor', N'http://ed-fi.org/ods/identity/claims/programEvaluationPeriodDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);

END

IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/programEvaluationTypeDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'programEvaluationTypeDescriptor', N'programEvaluationTypeDescriptor', N'http://ed-fi.org/ods/identity/claims/programEvaluationTypeDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/schoolChoiceBasisDescriptor' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'schoolChoiceBasisDescriptor', N'schoolChoiceBasisDescriptor', N'http://ed-fi.org/ods/identity/claims/schoolChoiceBasisDescriptor',
@systemDescriptorsResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/studentContactAssociation' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'studentContactAssociation', N'studentContactAssociation', N'http://ed-fi.org/ods/identity/claims/studentContactAssociation',
@relationshipBasedDataResourceClaimId, @applicationId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/studentSpecialEducationProgramEligibilityAssociation' AND Application_ApplicationId = @applicationId)
BEGIN

    INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
    VALUES (N'studentSpecialEducationProgramEligibilityAssociation', N'studentSpecialEducationProgramEligibilityAssociation', N'http://ed-fi.org/ods/identity/claims/studentSpecialEducationProgramEligibilityAssociation',
@relationshipBasedDataResourceClaimId, @applicationId);
