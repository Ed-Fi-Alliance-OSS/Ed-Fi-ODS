...
/* ------------------------------------------------ */
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('balanceSheetDimension', 'balanceSheetDimension', 'http://ed-fi.org/ods/identity/claims/balanceSheetDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('chartOfAccount', 'chartOfAccount', 'http://ed-fi.org/ods/identity/claims/chartOfAccount', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('contact', 'contact', 'http://ed-fi.org/ods/identity/claims/contact', peopleResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('descriptorMapping', 'descriptorMapping', 'http://ed-fi.org/ods/identity/claims/descriptorMapping', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('eligibilityDelayReasonDescriptor', 'eligibilityDelayReasonDescriptor', 'http://ed-fi.org/ods/identity/claims/eligibilityDelayReasonDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='eligibilityEvaluationTypeDescriptor') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('eligibilityEvaluationTypeDescriptor', 'eligibilityEvaluationTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/eligibilityEvaluationTypeDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('enrollmentTypeDescriptor', 'enrollmentTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/enrollmentTypeDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('functionDimension', 'functionDimension', 'http://ed-fi.org/ods/identity/claims/functionDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('ideaPartDescriptor', 'ideaPartDescriptor', 'http://ed-fi.org/ods/identity/claims/ideaPartDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localAccount', 'localAccount', 'http://ed-fi.org/ods/identity/claims/localAccount', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='localActual') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localActual', 'localActual', 'http://ed-fi.org/ods/identity/claims/localActual', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='localBudget') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localBudget', 'localBudget', 'http://ed-fi.org/ods/identity/claims/localBudget', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='localContractedStaff') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localContractedStaff', 'localContractedStaff', 'http://ed-fi.org/ods/identity/claims/localContractedStaff', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localEncumbrance', 'localEncumbrance', 'http://ed-fi.org/ods/identity/claims/localEncumbrance', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='localPayroll') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('localPayroll', 'localPayroll', 'http://ed-fi.org/ods/identity/claims/localPayroll', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('modelEntityDescriptor', 'modelEntityDescriptor', 'http://ed-fi.org/ods/identity/claims/modelEntityDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('objectDimension', 'objectDimension', 'http://ed-fi.org/ods/identity/claims/objectDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('operationalUnitDimension', 'operationalUnitDimension', 'http://ed-fi.org/ods/identity/claims/operationalUnitDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('programDimension', 'programDimension', 'http://ed-fi.org/ods/identity/claims/programDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='programEvaluation') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('programEvaluation', 'programEvaluation', 'http://ed-fi.org/ods/identity/claims/programEvaluation', relationshipBasedDataResourceClaimId, application_id);
    END IF;

    IF NOT EXISTS(SELECT 1 FROM dbo.ResourceClaims WHERE ResourceName ='programEvaluationElement') THEN
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('programEvaluationElement', 'programEvaluationElement', 'http://ed-fi.org/ods/identity/claims/programEvaluationElement', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('projectDimension', 'projectDimension', 'http://ed-fi.org/ods/identity/claims/projectDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('ratingLevelDescriptor', 'ratingLevelDescriptor', 'http://ed-fi.org/ods/identity/claims/ratingLevelDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('reportingTagDescriptor', 'reportingTagDescriptor', 'http://ed-fi.org/ods/identity/claims/reportingTagDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('schoolChoiceBasisDescriptor', 'schoolChoiceBasisDescriptor', 'http://ed-fi.org/ods/identity/claims/schoolChoiceBasisDescriptor', systemDescriptorsResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('sourceDimension', 'sourceDimension', 'http://ed-fi.org/ods/identity/claims/sourceDimension', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('studentContactAssociation', 'studentContactAssociation', 'http://ed-fi.org/ods/identity/claims/studentContactAssociation', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('studentProgramEvaluation', 'studentProgramEvaluation', 'http://ed-fi.org/ods/identity/claims/studentProgramEvaluation', relationshipBasedDataResourceClaimId, application_id);
    END IF;
    ...
    insert into dbo.ResourceClaims (DisplayName, ResourceName, ClaimName, ParentResourceClaimId, Application_ApplicationId)
    values ('studentSpecialEducationProgramEligibilityAssociation', 'studentSpecialEducationProgramEligibilityAssociation', 'http://ed-fi.org/ods/identity/claims/studentSpecialEducationProgramEligibilityAssociation', relationshipBasedDataResourceClaimId, application_id);
    END IF;
