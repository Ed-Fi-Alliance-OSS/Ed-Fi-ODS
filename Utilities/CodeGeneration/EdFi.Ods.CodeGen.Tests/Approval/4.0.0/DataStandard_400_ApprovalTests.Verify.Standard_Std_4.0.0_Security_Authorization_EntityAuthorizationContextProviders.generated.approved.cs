...
namespace EdFi.Ods.Api.Security.Authorization.ContextDataProviders.EdFi
{
    ...
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class ParentRelationshipsAuthorizationContextDataProvider : IRelationshipsAuthorizationContextDataProvider<IParent>
    {
        /// <summary>
        /// Creates and returns an <see cref="RelationshipsAuthorizationContextData"/> instance based on the supplied resource.
        /// </summary>
        public RelationshipsAuthorizationContextData GetContextData(IParent resource)
        {
            if (resource == null)
    ...
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class StudentDisciplineIncidentAssociationRelationshipsAuthorizationContextDataProvider : IRelationshipsAuthorizationContextDataProvider<IStudentDisciplineIncidentAssociation>
    {
        /// <summary>
        /// Creates and returns an <see cref="RelationshipsAuthorizationContextData"/> instance based on the supplied resource.
        /// </summary>
        public RelationshipsAuthorizationContextData GetContextData(IStudentDisciplineIncidentAssociation resource)
        {
            if (resource == null)
    ...
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class StudentLearningObjectiveRelationshipsAuthorizationContextDataProvider : IRelationshipsAuthorizationContextDataProvider<IStudentLearningObjective>
    {
        /// <summary>
        /// Creates and returns an <see cref="RelationshipsAuthorizationContextData"/> instance based on the supplied resource.
        /// </summary>
        public RelationshipsAuthorizationContextData GetContextData(IStudentLearningObjective resource)
        {
            if (resource == null)
    ...
    /// </summary>
    [ExcludeFromCodeCoverage]
    public class StudentParentAssociationRelationshipsAuthorizationContextDataProvider : IRelationshipsAuthorizationContextDataProvider<IStudentParentAssociation>
    {
        /// <summary>
        /// Creates and returns an <see cref="RelationshipsAuthorizationContextData"/> instance based on the supplied resource.
        /// </summary>
        public RelationshipsAuthorizationContextData GetContextData(IStudentParentAssociation resource)
        {
            if (resource == null)
