...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/learningObjective')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'learningObjective', N'http://ed-fi.org/ods/identity/claims/learningObjective',
@educationStandardsResourceClaimId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/oldEthnicityDescriptor')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'oldEthnicityDescriptor', N'http://ed-fi.org/ods/identity/claims/oldEthnicityDescriptor',
@systemDescriptorsResourceClaimId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/parent')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'parent', N'http://ed-fi.org/ods/identity/claims/parent',
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/studentDisciplineIncidentAssociation')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'studentDisciplineIncidentAssociation', N'http://ed-fi.org/ods/identity/claims/studentDisciplineIncidentAssociation',
@relationshipBasedDataResourceClaimId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/studentLearningObjective')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'studentLearningObjective', N'http://ed-fi.org/ods/identity/claims/studentLearningObjective',
@relationshipBasedDataResourceClaimId);
...
IF NOT EXISTS(SELECT 1 FROM [dbo].[ResourceClaims] WHERE [ClaimName] = 'http://ed-fi.org/ods/identity/claims/studentParentAssociation')
BEGIN

    INSERT [dbo].[ResourceClaims] ([ResourceName], [ClaimName], [ParentResourceClaimId])
    VALUES (N'studentParentAssociation', N'http://ed-fi.org/ods/identity/claims/studentParentAssociation',
@relationshipBasedDataResourceClaimId);
