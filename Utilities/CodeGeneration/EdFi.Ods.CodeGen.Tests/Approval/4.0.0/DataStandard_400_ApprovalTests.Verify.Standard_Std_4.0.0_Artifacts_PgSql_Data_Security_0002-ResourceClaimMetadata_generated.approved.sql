...
/* ------------------------------------------------ */
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('learningObjective', 'http://ed-fi.org/ods/identity/claims/learningObjective', educationStandardsResourceClaimId);
    END IF;
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('oldEthnicityDescriptor', 'http://ed-fi.org/ods/identity/claims/oldEthnicityDescriptor', systemDescriptorsResourceClaimId);
    END IF;
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('parent', 'http://ed-fi.org/ods/identity/claims/parent', peopleResourceClaimId);
    END IF;
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('studentDisciplineIncidentAssociation', 'http://ed-fi.org/ods/identity/claims/studentDisciplineIncidentAssociation', relationshipBasedDataResourceClaimId);
    END IF;
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('studentLearningObjective', 'http://ed-fi.org/ods/identity/claims/studentLearningObjective', relationshipBasedDataResourceClaimId);
    END IF;
    ...
    insert into dbo.ResourceClaims (ResourceName, ClaimName, ParentResourceClaimId)
    values ('studentParentAssociation', 'http://ed-fi.org/ods/identity/claims/studentParentAssociation', relationshipBasedDataResourceClaimId);
    END IF;
