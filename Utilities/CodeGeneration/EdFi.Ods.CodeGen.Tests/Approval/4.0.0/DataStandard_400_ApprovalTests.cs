...
namespace EdFi.Ods.CodeGen.Tests.Approval_Tests
{
    ...
    public class DataStandard_400_ApprovalTests
    {
        ...
        private static List<ApprovalFileInfo> GetApprovalFileInfos()
        {
            var generatedFileList = Path.Combine(
                _odsRepository,
                "Utilities", "CodeGeneration", "EdFi.Ods.CodeGen.Tests", "Approval", StandardVersion, $"{nameof(DataStandard_400_ApprovalTests)}.{nameof(Generated_File_List)}.Standard.{StandardVersion}.approved.txt");
                ...
                switch (ext.ToLower())
                {
                    ...
                    case ".sql":
                        ...
                        string destFileName = Path.Combine(
                            ...
                            , $"{nameof(DataStandard_400_ApprovalTests)}.Verify.{file.Scenario}.approved{ext}");
