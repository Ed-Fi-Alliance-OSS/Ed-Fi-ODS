...
{
    /// <summary>
    ///     Create a random 5 character string value
    /// </summary>
    public class StringPropertyBuilder : BaseBuilder
    {
        public StringPropertyBuilder(IPropertyInfoMetadataLookup metadataLookup)
            : base(metadataLookup) { }
