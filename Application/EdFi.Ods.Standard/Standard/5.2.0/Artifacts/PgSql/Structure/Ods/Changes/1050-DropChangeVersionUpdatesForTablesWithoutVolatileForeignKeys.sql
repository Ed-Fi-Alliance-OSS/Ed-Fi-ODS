...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'assessmentadministration') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.assessmentadministration';
END IF;

IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'assessmentadministrationparticipation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.assessmentadministrationparticipation';
END IF;

IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'assessmentbatterypart') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.assessmentbatterypart';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'contact') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.contact';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'crisisevent') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.crisisevent';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'evaluationrubricdimension') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.evaluationrubricdimension';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'programevaluation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.programevaluation';
END IF;

IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'programevaluationelement') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.programevaluationelement';
END IF;

IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'programevaluationobjective') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.programevaluationobjective';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studentassessmentregistrationbatterypartassociation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studentassessmentregistrationbatterypartassociation';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studentcontactassociation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studentcontactassociation';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studenteducationorganizationassessmentaccommodation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studenteducationorganizationassessmentaccommodation';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studenthealth') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studenthealth';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studentprogramevaluation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studentprogramevaluation';
END IF;
...
IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studentspecialeducationprogrameligibilityassociation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studentspecialeducationprogrameligibilityassociation';
END IF;

IF EXISTS(SELECT 1 FROM information_schema.triggers WHERE trigger_name = 'updatechangeversion' AND event_object_schema = 'edfi' AND event_object_table = 'studenttransportation') THEN
    EXECUTE 'DROP TRIGGER updatechangeversion ON edfi.studenttransportation';
END IF;
