...
CREATE INDEX IF NOT EXISTS IX_DisciplineIncident_StaffUSI ON edfi.DisciplineIncident(StaffUSI) INCLUDE (AggregateId);
...
CREATE INDEX IF NOT EXISTS IX_Parent_ParentUSI ON edfi.Parent(ParentUSI) INCLUDE (AggregateId);
...
DROP INDEX IF EXISTS IX_StudentDisciplineIncidentAssociation_SchoolId;
CREATE INDEX IF NOT EXISTS IX_StudentDisciplineIncidentAssociation_SchoolId ON edfi.StudentDisciplineIncidentAssociation(SchoolId) INCLUDE (AggregateId);

CREATE INDEX IF NOT EXISTS IX_StudentDisciplineIncidentAssociation_StudentUSI ON edfi.StudentDisciplineIncidentAssociation(StudentUSI) INCLUDE (AggregateId);
...
CREATE INDEX IF NOT EXISTS IX_StudentLearningObjective_StudentUSI ON edfi.StudentLearningObjective(StudentUSI) INCLUDE (AggregateId);

CREATE INDEX IF NOT EXISTS IX_StudentParentAssociation_ParentUSI ON edfi.StudentParentAssociation(ParentUSI) INCLUDE (AggregateId);

CREATE INDEX IF NOT EXISTS IX_StudentParentAssociation_StudentUSI ON edfi.StudentParentAssociation(StudentUSI) INCLUDE (AggregateId);
...
CREATE INDEX IF NOT EXISTS IX_SurveyResponse_ParentUSI ON edfi.SurveyResponse(ParentUSI) INCLUDE (AggregateId);
