...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_DisciplineIncident_StaffUSI' AND object_id = OBJECT_ID('edfi.DisciplineIncident')) 
BEGIN
    CREATE INDEX IX_DisciplineIncident_StaffUSI ON [edfi].[DisciplineIncident](StaffUSI) INCLUDE (AggregateId)
END;
...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_Parent_ParentUSI' AND object_id = OBJECT_ID('edfi.Parent')) 
BEGIN
    CREATE INDEX IX_Parent_ParentUSI ON [edfi].[Parent](ParentUSI) INCLUDE (AggregateId)
END;
...
DROP INDEX IF EXISTS IX_StudentDisciplineIncidentAssociation_SchoolId ON [edfi].[StudentDisciplineIncidentAssociation];
CREATE INDEX IX_StudentDisciplineIncidentAssociation_SchoolId ON [edfi].[StudentDisciplineIncidentAssociation](SchoolId) INCLUDE (AggregateId);

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentDisciplineIncidentAssociation_StudentUSI' AND object_id = OBJECT_ID('edfi.StudentDisciplineIncidentAssociation')) 
BEGIN
    CREATE INDEX IX_StudentDisciplineIncidentAssociation_StudentUSI ON [edfi].[StudentDisciplineIncidentAssociation](StudentUSI) INCLUDE (AggregateId)
END;
...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentLearningObjective_StudentUSI' AND object_id = OBJECT_ID('edfi.StudentLearningObjective')) 
BEGIN
    CREATE INDEX IX_StudentLearningObjective_StudentUSI ON [edfi].[StudentLearningObjective](StudentUSI) INCLUDE (AggregateId)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentParentAssociation_ParentUSI' AND object_id = OBJECT_ID('edfi.StudentParentAssociation')) 
BEGIN
    CREATE INDEX IX_StudentParentAssociation_ParentUSI ON [edfi].[StudentParentAssociation](ParentUSI) INCLUDE (AggregateId)
END;

IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_StudentParentAssociation_StudentUSI' AND object_id = OBJECT_ID('edfi.StudentParentAssociation')) 
BEGIN
    CREATE INDEX IX_StudentParentAssociation_StudentUSI ON [edfi].[StudentParentAssociation](StudentUSI) INCLUDE (AggregateId)
END;
...
IF NOT EXISTS(SELECT * FROM sys.indexes WHERE name='IX_SurveyResponse_ParentUSI' AND object_id = OBJECT_ID('edfi.SurveyResponse')) 
BEGIN
    CREATE INDEX IX_SurveyResponse_ParentUSI ON [edfi].[SurveyResponse](ParentUSI) INCLUDE (AggregateId)
END;
