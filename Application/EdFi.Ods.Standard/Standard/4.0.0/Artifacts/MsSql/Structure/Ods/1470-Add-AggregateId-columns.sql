...
ALTER TABLE [edfi].[LearningObjective] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [edfi].[LearningObjective_AggSeq];
...
ALTER TABLE [edfi].[Parent] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [edfi].[Parent_AggSeq];
...
ALTER TABLE [edfi].[StudentDisciplineIncidentAssociation] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [edfi].[StudentDisciplineIncidentAssociation_AggSeq];
...
ALTER TABLE [edfi].[StudentLearningObjective] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [edfi].[StudentLearningObjective_AggSeq];
...
ALTER TABLE [edfi].[StudentParentAssociation] ADD AggregateId int NOT NULL DEFAULT NEXT VALUE FOR [edfi].[StudentParentAssociation_AggSeq];
