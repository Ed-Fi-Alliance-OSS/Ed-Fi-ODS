...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/domains/transportation'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/domains/transportation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            VALUES ('transportation', 'http://ed-fi.org/ods/identity/claims/domains/transportation', @parentResourceClaimId)
    ...
    -- Processing claim sets for http://ed-fi.org/ods/identity/claims/domains/transportation
    ----------------------------------------------------------------------------------------------------------------------------
    ...
    -- Processing children of http://ed-fi.org/ods/identity/claims/domains/transportation
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/domains/transportation/studentTransportation'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/domains/transportation/studentTransportation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('studentTransportation', 'http://ed-fi.org/ods/identity/claims/domains/transportation/studentTransportation', @parentResourceClaimId)
    ...
    -- Processing children of http://ed-fi.org/ods/identity/claims/domains/transportation/studentTransportation
    ----------------------------------------------------------------------------------------------------------------------------
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/studentBusDetails'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/studentBusDetails'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('studentBusDetails', 'http://ed-fi.org/ods/identity/claims/ed-fi/studentBusDetails', @parentResourceClaimId)
