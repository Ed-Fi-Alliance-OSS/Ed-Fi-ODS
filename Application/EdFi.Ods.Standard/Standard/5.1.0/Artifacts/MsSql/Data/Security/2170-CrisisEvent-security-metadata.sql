...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/domains/systemDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            VALUES ('systemDescriptor', 'http://ed-fi.org/ods/identity/claims/domains/systemDescriptor', @parentResourceClaimId)
