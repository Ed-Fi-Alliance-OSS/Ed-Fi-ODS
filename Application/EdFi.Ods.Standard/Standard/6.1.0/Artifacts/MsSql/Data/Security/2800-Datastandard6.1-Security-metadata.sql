...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceDeliveryDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceDeliveryDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('serviceDeliveryDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceDeliveryDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceLocationTypeDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceLocationTypeDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('serviceLocationTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceLocationTypeDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/eventComplianceDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/eventComplianceDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('eventComplianceDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/eventComplianceDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/iDEAEventDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('iDEAEventDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/iDEAEventDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/iEPStatusDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('iEPStatusDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/iEPStatusDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/servicePrescriptionDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/servicePrescriptionDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('servicePrescriptionDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/servicePrescriptionDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/iEPGoalTypeDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('iEPGoalTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/iEPGoalTypeDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceProviderTypeDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceProviderTypeDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('serviceProviderTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceProviderTypeDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/eventReasonDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/eventReasonDescriptor'
    SET @claimId = NULL
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/frequencyIntervalDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/frequencyIntervalDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('frequencyIntervalDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/frequencyIntervalDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/addressCharacteristicDescriptor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/addressCharacteristicDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('addressCharacteristicDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/addressCharacteristicDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('specialEducation', 'http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation', @parentResourceClaimId)
    ...
    -- Processing claim sets for http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation
    ----------------------------------------------------------------------------------------------------------------------------
    -- Claim set: 'SIS Vendor'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimSetName = 'SIS Vendor'
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/iDEAEvent'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('iDEAEvent', 'http://ed-fi.org/ods/identity/claims/ed-fi/iDEAEvent', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEP'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEP'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('StudentIEP', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEP', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPGoal'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPGoal'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('StudentIEPGoal', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPGoal', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServiceDelivery'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServiceDelivery'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('StudentIEPServiceDelivery', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServiceDelivery', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    -- Resource Claim: 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServicePrescription'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServicePrescription'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('StudentIEPServicePrescription', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServicePrescription', @parentResourceClaimId)
