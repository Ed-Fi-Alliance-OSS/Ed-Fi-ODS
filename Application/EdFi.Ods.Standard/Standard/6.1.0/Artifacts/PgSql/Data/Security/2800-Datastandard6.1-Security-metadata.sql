...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceDeliveryDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('serviceDeliveryDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceDeliveryDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceLocationTypeDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('serviceLocationTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceLocationTypeDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/eventComplianceDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('eventComplianceDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/eventComplianceDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/servicePrescriptionDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('servicePrescriptionDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/servicePrescriptionDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceProviderTypeDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('serviceProviderTypeDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/serviceProviderTypeDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/eventReasonDescriptor';
    claim_id := NULL;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/frequencyIntervalDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('frequencyIntervalDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/frequencyIntervalDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/addressCharacteristicDescriptor';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('addressCharacteristicDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/addressCharacteristicDescriptor', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('specialEducation', 'http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    -- Processing claimsets for http://ed-fi.org/ods/identity/claims/ed-fi/specialEducation
    ----------------------------------------------------------------------------------------------------------------------------
    -- Claim set: 'SIS Vendor'
    ----------------------------------------------------------------------------------------------------------------------------
    claim_set_name := 'SIS Vendor';
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEP';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('StudentIEP', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEP', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPGoal';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('StudentIEPGoal', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPGoal', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServiceDelivery';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('StudentIEPServiceDelivery', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServiceDelivery', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    claim_name := 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServicePrescription';
    claim_id := NULL;
    ...
    IF claim_id IS NULL THEN
        ...
        INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
        VALUES ('StudentIEPServicePrescription', 'http://ed-fi.org/ods/identity/claims/ed-fi/StudentIEPServicePrescription', parent_resource_claim_id)
        RETURNING ResourceClaimId
        INTO claim_id;
