...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/educationOrganizationIdentificationCode'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('educationOrganizationIdentificationCode', 'http://ed-fi.org/ods/identity/claims/educationOrganizationIdentificationCode', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/studentIdentificationCode'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('studentIdentificationCode', 'http://ed-fi.org/ods/identity/claims/studentIdentificationCode', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/contactIdentificationCode'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('contactIdentificationCode', 'http://ed-fi.org/ods/identity/claims/contactIdentificationCode', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/staffIdentificationCode'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('staffIdentificationCode', 'http://ed-fi.org/ods/identity/claims/staffIdentificationCode', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/candidateIdentificationCode'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('candidateIdentificationCode', 'http://ed-fi.org/ods/identity/claims/candidateIdentificationCode', @parentResourceClaimId)
