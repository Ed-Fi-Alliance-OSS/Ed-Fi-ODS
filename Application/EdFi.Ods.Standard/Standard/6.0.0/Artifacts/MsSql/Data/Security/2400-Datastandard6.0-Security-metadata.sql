...
BEGIN
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/educatorPreparationProgram'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('educatorPreparationProgram', 'http://ed-fi.org/ods/identity/claims/ed-fi/educatorPreparationProgram', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/staffEducatorPreparationProgramAssociation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('staffEducatorPreparationProgramAssociation', 'http://ed-fi.org/ods/identity/claims/ed-fi/staffEducatorPreparationProgramAssociation', @parentResourceClaimId)
    ...
    -- Processing claim sets for http://ed-fi.org/ods/identity/claims/domains/epdm/credentials
    ----------------------------------------------------------------------------------------------------------------------------
    -- Claim set: 'Ed-Fi Sandbox'
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimSetName = 'Ed-Fi Sandbox'
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/candidateEducatorPreparationProgramAssociation'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('candidateEducatorPreparationProgramAssociation', 'http://ed-fi.org/ods/identity/claims/candidateEducatorPreparationProgramAssociation', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/contactIdentity'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('contactIdentity', 'http://ed-fi.org/ods/identity/claims/contactIdentity', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/performanceEvaluationRatingLevelDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('performanceEvaluationRatingLevelDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/performanceEvaluationRatingLevelDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/evaluationPeriodDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('evaluationPeriodDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/evaluationPeriodDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/candidateIdentificationSystemDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('candidateIdentificationSystemDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/candidateIdentificationSystemDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/contactIdentificationSystemDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('contactIdentificationSystemDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/contactIdentificationSystemDescriptor', @parentResourceClaimId)
    ...
    ----------------------------------------------------------------------------------------------------------------------------
    SET @claimName = 'http://ed-fi.org/ods/identity/claims/ed-fi/economicDisadvantageDescriptor'
    SET @claimId = NULL
    ...
    IF @claimId IS NULL
        BEGIN
            ...
            INSERT INTO dbo.ResourceClaims(ResourceName, ClaimName, ParentResourceClaimId)
            VALUES ('economicDisadvantageDescriptor', 'http://ed-fi.org/ods/identity/claims/ed-fi/economicDisadvantageDescriptor', @parentResourceClaimId)
