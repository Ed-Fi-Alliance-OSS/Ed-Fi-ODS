...
(
       OldCompetencyObjective [NVARCHAR](60) NOT NULL,
       OldCompetencyObjectiveEducationOrganizationId [INT] NOT NULL,
       OldCompetencyObjectiveGradeLevelDescriptorId [INT] NOT NULL,
       OldCompetencyObjectiveGradeLevelDescriptorNamespace [NVARCHAR](255) NOT NULL,
       OldCompetencyObjectiveGradeLevelDescriptorCodeValue [NVARCHAR](50) NOT NULL,
       OldGradingPeriodDescriptorId [INT] NOT NULL,
       OldGradingPeriodDescriptorNamespace [NVARCHAR](255) NOT NULL,
       OldGradingPeriodDescriptorCodeValue [NVARCHAR](50) NOT NULL,
       OldGradingPeriodSchoolId [INT] NOT NULL,
       ...
       OldStudentUSI [INT] NOT NULL,
       OldStudentUniqueId [NVARCHAR](32) NOT NULL,
       NewCompetencyObjective [NVARCHAR](60) NULL,
       NewCompetencyObjectiveEducationOrganizationId [INT] NULL,
       NewCompetencyObjectiveGradeLevelDescriptorId [INT] NULL,
       NewCompetencyObjectiveGradeLevelDescriptorNamespace [NVARCHAR](255) NULL,
       NewCompetencyObjectiveGradeLevelDescriptorCodeValue [NVARCHAR](50) NULL,
       NewGradingPeriodDescriptorId [INT] NULL,
       NewGradingPeriodDescriptorNamespace [NVARCHAR](255) NULL,
       NewGradingPeriodDescriptorCodeValue [NVARCHAR](50) NULL,
       NewGradingPeriodSchoolId [INT] NULL,
