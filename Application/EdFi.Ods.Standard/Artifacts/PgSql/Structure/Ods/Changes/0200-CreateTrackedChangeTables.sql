...
(
       oldcompetencyobjective VARCHAR(60) NOT NULL,
       oldcompetencyobjectiveeducationorganizationid INT NOT NULL,
       oldcompetencyobjectivegradeleveldescriptorid INT NOT NULL,
       oldcompetencyobjectivegradeleveldescriptornamespace VARCHAR(255) NOT NULL,
       oldcompetencyobjectivegradeleveldescriptorcodevalue VARCHAR(50) NOT NULL,
       oldgradingperioddescriptorid INT NOT NULL,
       oldgradingperioddescriptornamespace VARCHAR(255) NOT NULL,
       oldgradingperioddescriptorcodevalue VARCHAR(50) NOT NULL,
       oldgradingperiodschoolid INT NOT NULL,
       ...
       oldstudentusi INT NOT NULL,
       oldstudentuniqueid VARCHAR(32) NOT NULL,
       newcompetencyobjective VARCHAR(60) NULL,
       newcompetencyobjectiveeducationorganizationid INT NULL,
       newcompetencyobjectivegradeleveldescriptorid INT NULL,
       newcompetencyobjectivegradeleveldescriptornamespace VARCHAR(255) NULL,
       newcompetencyobjectivegradeleveldescriptorcodevalue VARCHAR(50) NULL,
       newgradingperioddescriptorid INT NULL,
       newgradingperioddescriptornamespace VARCHAR(255) NULL,
       newgradingperioddescriptorcodevalue VARCHAR(50) NULL,
       newgradingperiodschoolid INT NULL,
