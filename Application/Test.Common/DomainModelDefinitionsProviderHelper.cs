                ...
                new DomainModelDefinitions(
                    ...
                    new[]
                    {
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                ...
                                new EP("FirstName", new PT(DbType.String, 75,0 , 0, 0, false), "", false, false),
                                new EP("MiddleName", new PT(DbType.String, 75, 0, 0, 0, true), "", false, false),
                                new EP("LastSurname", new PT(DbType.String, 75,0 , 0, 0, false), "", false, false),
                                ...
                                new EP("BirthDate", new PT(DbType.Date, 0, 0, 0, 0, true), "", false, false),
                                new EP("HispanicLatinoEthnicity", new PT(DbType.Boolean, 0, 0, 0, 0, true), "", false, false),
                                ...
                                new EP("HighlyQualifiedTeacher", new PT(DbType.Boolean, 0, 0, 0, 0, true), "", false, false),
                        ...
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                ...
                                new EP("BuildingSiteNumber", new PT(DbType.String, 20, 0, 0, 0, true), "", false, false),
                                ...
                                new EP("Latitude", new PT(DbType.String, 20, 0, 0, 0, true), "", false, false),
                                new EP("Longitude", new PT(DbType.String, 20, 0, 0, 0, true), "", false, false),
                                new EP("BeginDate", new PT(DbType.Date, 0, 0, 0, 0, true), "", false, false),
                                new EP("EndDate", new PT(DbType.Date, 0, 0, 0, 0, true), "", false, false),
                                new EP("CreateDate", new PT(DbType.DateTime, 0,0 , 0, 0, false), "", false, false)
                            },
                            new[]
                            {
                        ...
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                new EP("ProbationCompleteDate", new PT(DbType.Date, 0, 0, 0, 0, true), "", false, false),
                                new EP("Tenured", new PT(DbType.Boolean, 0, 0, 0, 0, true), "", false, false),
                                new EP("CreateDate", new PT(DbType.DateTime, 0,0 , 0, 0, false), "", false, false)
                            },
                            new[]
                            {
                    ...
                    new[]
                    {
                        ...
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("AddressTypeDescriptorId", new PT(DbType.Int32, 0, 0, 10, 0, false), "", true, false)
                            },
                            true,
                            true),
                        new AssociationDefinition(
                        ...
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("StaffUSI", new PT(DbType.Int32, 0, 0, 10, 0, false), "", true, false)
                            },
                            true,
                            true),
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("StateAbbreviationDescriptorId", new PT(DbType.Int32, 0, 0, 10, 0, false), "", false, false)
                            },
                            false,
                            true),
                        new AssociationDefinition(
                ...
                new DomainModelDefinitions(
                    ...
                    new[]
                    {
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                new EP("FirstPetOwnedDate", new PT(DbType.Date, 0, 0, 0, 0, true), "", false, false),
                                new EP("CreateDate", new PT(DbType.DateTime, 0,0 , 0, 0, false), "", false, false)
                            },
                            new[]
                            {
                        ...
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                new EP("PetName", new PT(DbType.String, 20,0 , 0, 0, false), "", true, false),
                                new EP("IsFixed", new PT(DbType.Boolean, 0, 0, 0, 0, true), "", false, false),
                                new EP("CreateDate", new PT(DbType.DateTime, 0,0 , 0, 0, false), "", false, false)
                            },
                            new[]
                            {
                        ...
                        new EntityDefinition(
                            ...
                            new[]
                            {
                                new EP("MinimumWeight", new PT(DbType.Int32, 0, 0, 10, 0, false), "", false, false),
                                new EP("MaximumWeight", new PT(DbType.Int32, 0, 0, 10, 0, false), "", false, false),
                                new EP("CreateDate", new PT(DbType.DateTime, 0,0 , 0, 0, false), "", false, false)
                            },
                            new[]
                            {
                    ...
                    new[]
                    {
                        ...
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("StaffUSI", new PT(DbType.Int32, 0, 0, 10, 0, false), "", true, true)
                            },
                            true,
                            true),
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("StudentUSI", new PT(DbType.Int32, 0, 0, 10, 0, false), "", true, false)
                            },
                            true,
                            true),
                        new AssociationDefinition(
                            ...
                            new[]
                            {
                                new EP("StudentUSI", new PT(DbType.Int32, 0, 0, 10, 0, false), "", true, true)
                            },
                            true,
                            true)
                    },
