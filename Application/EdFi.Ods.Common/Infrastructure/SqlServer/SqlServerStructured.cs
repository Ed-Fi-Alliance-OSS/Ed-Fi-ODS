...
{
    /// <summary>
    /// Provides an abstract implementation of a custom NHibernate <see cref="NHibernate.Type.IType"/> that provides
    /// access to SQL Server table-valued parameters through the <see cref="System.Data.SqlDbType.Structured"/>
    /// parameter type.
    /// </summary>
