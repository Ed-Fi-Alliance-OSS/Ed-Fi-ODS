...
namespace EdFi.Ods.Common.Infrastructure.Filtering
{
    ...
    /// </summary>
    public interface IAuthorizationFilterApplicationDetailsProvider
    {
        /// <summary>
        ...
        FilterApplicationDetails GetFilterDefinition(string filterName);
        
        /// <summary>
        /// Attempts to get the filter definition containing information for applying the specified filter in various contexts.
        /// </summary>
        /// <param name="filterName">The name of the filter.</param>
        /// <param name="filterApplicationDetails">The filter definition.</param>
        /// <returns><b>true</b> if the filter was found; otherwise <b>false</b>.</returns>
        bool TryGetAuthorizationFilterDefinition(string filterName, out FilterApplicationDetails filterApplicationDetails);
    }
}
