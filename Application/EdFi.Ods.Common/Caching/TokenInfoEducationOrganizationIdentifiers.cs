...
{
    public class TokenInfoEducationOrganizationIdentifiers
    {
        private TokenInfoEducationOrganizationIdentifiers(int educationOrganizationId)
        {
            EducationOrganizationId = educationOrganizationId;
        }

        public TokenInfoEducationOrganizationIdentifiers() { }
        ...
        public static TokenInfoEducationOrganizationIdentifiers CreateLookupInstance(int educationOrganizationId)
        {
            return new TokenInfoEducationOrganizationIdentifiers(educationOrganizationId);
        }
    }
}
