...
namespace EdFi.Ods.Common.Database
{
    ...
    public class PrototypeWithDatabaseNameTokenReplacementConnectionStringProvider : IDatabaseConnectionStringProvider
    {
        ...
        public string GetConnectionString()
        {
            ...
            connectionStringBuilder.DatabaseName = connectionStringBuilder.DatabaseName.IsFormatString() ? string.Format(
                    connectionStringBuilder.DatabaseName, _databaseNameReplacementTokenProvider.GetReplacementToken()) :
                    connectionStringBuilder.DatabaseName;
            
            return _connectionStringsByNames.GetOrAdd(
                Tuple.Create(_prototypeConnectionStringName, connectionStringBuilder.DatabaseName), x => connectionStringBuilder.ConnectionString);
        }
    }
}
