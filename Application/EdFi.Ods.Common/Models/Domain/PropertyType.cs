...
namespace EdFi.Ods.Common.Models.Domain
{
    ...
    {
        public PropertyType(DbType dbType, int maxLength = 0, int precision = 0, int scale = 0, bool isNullable = false, dynamic minValue = null, dynamic maxValue = null, int minLength = 0)
        {
