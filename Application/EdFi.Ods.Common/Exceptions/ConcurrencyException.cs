...
namespace EdFi.Ods.Common.Exceptions
{
    public class ConcurrencyException : ConflictException
    {
        ...
        private const string DetailText = "The item was modified or deleted by another user while processing the request. Resending this request will either recreate the item, or introduce of copy with a different identifier.";
