            ...
            protected override void Arrange()
            {
                ...
                bldr.AddEntity(
                    new EntityDefinition(
                        ...
                        new[]
                        {
                            ...
                            new EP(
                                "EffectiveBeginDate",
                                new PT(DbType.Date, 0, 0, 0, true, 0),
                ...
                bldr.AddEntity(
                    new EntityDefinition(
                        ...
                        new[]
                        {
                            new EP("FundingSourceTypeId", new PT(DbType.Int32, 0, 10, 0, false, 0), "", true, true),
                            new EP("CodeValue", new PT(DbType.String, 50, 0, 0, false, 0), "", false, false),
                            new EP("Description", new PT(DbType.String, 1024, 0, 0, false, 0), "", false, false),
                            new EP("ShortDescription", new PT(DbType.String, 450, 0, 0, false, 0), "", false, false),
                            new EP("Id", new PT(DbType.Guid, 0, 0, 0, false, 0), "", false, false),
                            new EP("LastModifiedDate", new PT(DbType.DateTime, 0, 0, 0, false, 0), "", false, false),
                            new EP("CreateDate", new PT(DbType.DateTime, 0, 0, 0, false, 0), "", false, false)
                        },
                ...
                bldr.AddEntity(
                    new EntityDefinition(
                        ...
                        new[]
                        {
                            ...
                            new EP(
                                "RequisitionNumber",
                                new PT(DbType.String, 20, 0, 0, false, 0),
                ...
                bldr.AddEntity(
                    new EntityDefinition(
                        ...
                        new[]
                        {
                            ...
                            new EP("IsActive", new PT(DbType.Boolean, 0, 0, 0, true, 0), "", false, false),
                            ...
                            new EP("HighNeedAcademicSubject", new PT(DbType.Boolean, 0, 0, 0, true, 0), "", false, false),
                            new EP("PositionControlNumber", new PT(DbType.String, 20, 0, 0, true, 0), "", false, false),
                ...
                bldr.AddAssociation(
                    new AssociationDefinition(
                        ...
                        new[]
                        {
                            new EP("FundingSourceDescriptorId", new PT(DbType.Int32, 0, 10, 0, false, 0), "", true, true)
                        },
                        true,
                        true));
                ...
                bldr.AddAssociation(
                    new AssociationDefinition(
                        ...
                        new[]
                        {
                            ...
                            new EP("RequisitionNumber", new PT(DbType.String, 20, 0, 0, false, 0), "", true, false)
                        },
                        true,
                        true));
                ...
                bldr.AddAssociation(
                    new AssociationDefinition(
                        ...
                        new[]
                        {
                            new EP("FundingSourceDescriptorId", new PT(DbType.Int32, 0, 10, 0, false, 0), "", false, false)
                        },
                        new FullName("extension", "OpenStaffPositionExtension"),
                        new[]
                        {
                ...
                bldr.AddAssociation(
                    new AssociationDefinition(
                        ...
                        new[]
                        {
                            new EP("FundingSourceTypeId", new PT(DbType.Int32, 0, 10, 0, false, 0), "", false, true)
                        },
                        new FullName("extension", "FundingSourceDescriptor"),
                        new[]
                        {
                            new EP("FundingSourceTypeId", new PT(DbType.Int32, 0, 10, 0, false, 0), "", false, false)
                        },
                        false,
                        true));
