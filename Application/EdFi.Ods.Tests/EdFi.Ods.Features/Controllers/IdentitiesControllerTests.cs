...
namespace EdFi.Ods.Tests.EdFi.Ods.Features.Controllers
{
    public class TestIdentitiesController
        : IdentitiesControllerBase<IdentityCreateRequest, IdentitySearchRequest, IdentitySearchResponse<IdentityResponse>,
            IdentityResponse>
    {
        public TestIdentitiesController(IIdentityService<IdentityCreateRequest, IdentitySearchRequest, IdentitySearchResponse<IdentityResponse>, IdentityResponse> identitySubsystem, IIdentityServiceAsync<IdentitySearchRequest, IdentitySearchResponse<IdentityResponse>, IdentityResponse> identitySubsystemAsync, ApiSettings apiSettings)
    ...
    public class IdentitiesControllerTests
    {
        public class InvalidPropertiesGetByIdRequest : TestFixtureAsyncBase
        {
            ...
            protected override Task ArrangeAsync()
            {
                ...
                _controller = new (identityService, identityService, BuildApiSettings());
        ...
        public class IncompleteGetByIdRequest : TestFixtureAsyncBase
        {
            ...
            protected override Task ArrangeAsync()
            {
                ...
                _controller = new TestIdentitiesController(identityService, identityService, BuildApiSettings());
                return Task.CompletedTask;
            }
        ...
        public class SuccessCreateRequestWithReverseProxySettings : TestFixtureAsyncBase
        {
            ...
            {
                var identityService = new TestIdentitiesService(TestIdentitiesService.ResponseBehaviour.Success);
                _controller = new TestIdentitiesController(identityService, identityService, BuildApiSettings(useReverseProxyHeaders: true));
        ...
        public class IncompleteResultRequest : TestFixtureAsyncBase
        {
            ...
            protected override Task ArrangeAsync()
            {
                ...
                var identityService = new TestIdentitiesService(TestIdentitiesService.ResponseBehaviour.Incomplete);
                _controller = new TestIdentitiesController(identityService, identityService, BuildApiSettings()) {ControllerContext = controllerContext};
                return Task.CompletedTask;
            }
        ...
        public class UnknownResult : TestFixtureAsyncBase
        {
            ...
            public void Should_return_success_details()
            {
                ...
                AssertHelper.All(
                    ...
                    () => response!.Message.ShouldBe("Invalid response from identity service: An unknown error occurred, Another unknown error occurred."));
            }
        }
        ...
        private static ApiSettings BuildApiSettings(bool useReverseProxyHeaders = false)
        {
