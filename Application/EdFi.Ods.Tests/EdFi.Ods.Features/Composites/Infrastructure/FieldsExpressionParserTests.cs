...
namespace EdFi.Ods.Tests.EdFi.Ods.Repositories.NHibernate.Composites
{
        ...
        : ScenarioFor<FieldsExpressionParser>
    {
        ...
        {
            var result = SystemUnderTest.ParseFields("someProperty1,someProperty2");
        ...
        {
            var result = SystemUnderTest.ParseFields("someProperty1,someReference(*)");
        ...
        {
            var result = SystemUnderTest.ParseFields("someProperty1,someReference(someRefProp1,someRefProp2)");
        ...
        {
            var result = SystemUnderTest.ParseFields(
        ...
        {
            var result = SystemUnderTest.ParseFields("a(,b)");
        ...
        {
            Should.Throw<ArgumentException>(()=> SystemUnderTest.ParseFields("a()"));
        }

        [Assert]
        public void Should_throw_exception_if_grandchild_fields_expression_is_empty()
        {
            Should.Throw<ArgumentException>(()=> SystemUnderTest.ParseFields("a(b())"));
        }
