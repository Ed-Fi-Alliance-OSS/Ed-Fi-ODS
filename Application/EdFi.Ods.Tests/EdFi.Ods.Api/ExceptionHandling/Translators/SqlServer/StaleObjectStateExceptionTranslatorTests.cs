        ...
        public class When_an_nHibernate_StaleObjectState_exception_is_thrown : TestFixtureBase
        {
            ...
            public void Should_set_a_reasonable_message()
            {
                actualError.Detail.ShouldBe(
                    "The item was modified or deleted by another user while processing the request. Resending this request will either recreate the item, or introduce of copy with a different identifier.");
            }
