...
//            protected override void Arrange()
//            {
//                var routeInformation = Stub<IOpenApiMetadataRouteInformation>();
//                A.CallTo(() => routeInformation.GetRouteInformation()).Returns(new RouteInformation { Name = OpenApiMetadataSections.Other });
//                var apicontentInformation = Stub<IOpenApiContentProvider>();
//                _resourceModelProvider = Stub<IResourceModelProvider>();

//                var _openAPIMetadataRouteInformation = Stub<List<IOpenApiMetadataRouteInformation>>();

//                _openAPIMetadataRouteInformation.Add(routeInformation);
