...
namespace EdFi.Ods.Tests.EdFi.Ods.Api.Services.Filters
{
    ...
    //             var actionFilter = new CheckModelForNullFilter();
    //             actionexecutingcontext.ActionDescriptor.Properties.Add("request", "ParameterValue");
    //             actionexecutingcontext.ActionDescriptor.Properties.Add("classParameter", new CheckModelForNullFilter());
    //
    //             actionFilter.OnActionExecutionAsync(actionexecutingcontext);
