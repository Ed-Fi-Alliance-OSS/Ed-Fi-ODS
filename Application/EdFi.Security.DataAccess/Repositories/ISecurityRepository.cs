...
namespace EdFi.Security.DataAccess.Repositories
{
    public interface ISecurityRepository
    {
        ...
        IEnumerable<ClaimSetResourceClaimActionAuthorizations> GetClaimsForClaimSet(string claimSetName);
        ...
        IEnumerable<ResourceClaimActionAuthorization> GetResourceClaimLineageMetadata(string resourceClaimUri, string action);
