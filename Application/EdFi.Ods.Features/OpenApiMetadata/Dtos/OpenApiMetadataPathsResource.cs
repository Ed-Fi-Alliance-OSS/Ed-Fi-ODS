...
{
    public class OpenApiMetadataPathsResource : OpenApiMetadataResource
    {
        private static readonly Regex _isCompositeRouteTemplatePath = new Regex("/{(\\w+)}/");

        private string _path;

        public OpenApiMetadataPathsResource(Resource resource)
            : base(resource) { }

        public OpenApiMetadataPathsResource(OpenApiMetadataResource OpenApiMetadataResource)
            : base(OpenApiMetadataResource) { }
