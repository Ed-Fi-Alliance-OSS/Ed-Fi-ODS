...
{
    public class OpenApiMetadataDocumentContext
    {
        public OpenApiMetadataDocumentContext(IResourceModel resourceModel)
        {
        ...
        public OpenApiMetadataProfileContext ProfileContext { get; set; }

        public OpenApiMetadataCompositeContext CompositeContext { get; set; }
    ...
    /// <summary>
    /// Describes the rendering modes of the OpenApiMetadataDocumentFactory
    /// </summary>
