...
{
    public class KeyChangesRouteConvention : IApplicationModelConvention
    {
        private readonly ApiSettings _apiSettings;

        public KeyChangesRouteConvention(ApiSettings apiSettings)
        {
        ...
        public void Apply(ApplicationModel application)
        {
            var controller =
                application.Controllers.FirstOrDefault(
                    x => x.ControllerType == typeof(KeyChangesController).GetTypeInfo());
