...
public class ReferenceDataGetPipelineStepsProviderDecorator : IGetPipelineStepsProvider
{
    ...
    public ReferenceDataGetPipelineStepsProviderDecorator(IGetPipelineStepsProvider next)
    {
        _next = next;
    }
    ...
    public Type[] GetSteps()
    {
        return _next.GetSteps()
            .InsertBefore(typeof(GetEntityModelById<,,,>),
                typeof(InitializeReferenceDataLookupContext<,,,>))
            .InsertBefore(typeof(MapEntityModelToResourceModel<,,,>), 
