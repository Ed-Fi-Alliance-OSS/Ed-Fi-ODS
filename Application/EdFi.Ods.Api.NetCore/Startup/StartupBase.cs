...
namespace EdFi.Ods.Api.NetCore.Startup
{
    ...
    {
        public const string CorsPolicyName = "_development_";
        ...
        public void InitalizeStartup(IConfigurationBuilder builder)
        {
        ...
        public void ConfigureStartup(IApplicationBuilder app, IWebHostEnvironment env, ILoggerFactory loggerFactory)
        {
            loggerFactory.AddLog4Net();

            ApplicationBuilderConfiguration(app, env);
        ...
        public void ApplicationBuilderConfiguration(IApplicationBuilder app, IWebHostEnvironment env)
        {
