...
namespace EdFi.Ods.Api.NHibernate.Architecture.Extensions
{
    public static class IQueryExtensions
    {
        /// <summary>
        /// Sets the value of multiple parameters (by name) on the <see cref="IQuery"/> from the supplied dictionary.
        /// </summary>
