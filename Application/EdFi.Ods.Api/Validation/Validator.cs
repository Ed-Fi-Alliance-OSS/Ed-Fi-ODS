...
// namespace System.ComponentModel.DataAnnotations
{
    ...
    public static class Validator
    {
        ...
        public static bool TryValidateObject(
            ...
            TryValidateObject(instance, validationContext, validationResults, validateAllProperties: false, validateEverything: false);
        ...
        /// </param>
        /// <param name="validateEverything">Prevent short circuiting logic to prioritize getting all validation errors.</param>
        /// <returns><c>true</c> if the object is valid, <c>false</c> if any validation errors are encountered.</returns>
        /// <exception cref="ArgumentNullException">When <paramref name="instance" /> is null.</exception>
        /// <exception cref="ArgumentException">
        ///     When <paramref name="instance" /> doesn't match the
        ...
        public static bool TryValidateObject(object instance, ValidationContext validationContext,
            ICollection<ValidationResult>? validationResults, bool validateAllProperties, bool validateEverything)
        {
            ...
            foreach (ValidationError err in GetObjectValidationErrors(instance, validationContext!, validateAllProperties, breakOnFirstError, validateEverything))
            {
                result = false;
        ...
        {
            ValidateObject(instance, validationContext, validateAllProperties: false, validateEverything: false);
        }
        ...
        // [RequiresUnreferencedCode(ValidationContext.InstanceTypeNotStaticallyDiscovered)]
        public static void ValidateObject(object instance, ValidationContext validationContext,
            bool validateAllProperties, bool validateEverything)
        {
            ArgumentNullException.ThrowIfNull(instance);
            ...
            {
                throw new ArgumentException("Instance Must Match ValidationContext Instance", nameof(instance));
            }

            List<ValidationError> errors = GetObjectValidationErrors(instance, validationContext, validateAllProperties, breakOnFirstError: false, validateEverything);
            if (errors.Count > 0)
            {
                errors[0].ThrowValidationException();
            }
        ...
        private static void EnsureValidPropertyType(string propertyName, Type propertyType, object? value)
        {
            ...
            {
                throw new ArgumentException(string.Format("Validator_Property_Value_Wrong_Type for property '{0}' of type '{1}'.", propertyName, propertyType),
                                            nameof(value));
            }
        }
        ...
        private static List<ValidationError> GetObjectValidationErrors(object instance,
            ValidationContext validationContext, bool validateAllProperties, bool breakOnFirstError, bool validateEverything)
        {
            ArgumentNullException.ThrowIfNull(validationContext);
            ...
            if (!validateEverything && errors.Count > 0)
            {
                return errors;
            }
