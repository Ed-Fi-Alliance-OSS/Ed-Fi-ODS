...
{
    /// <summary>
    /// Defines a method for constructing the convention-based authorization filter name.
    /// </summary>
    public static class FilterNameHelper
    {
        /// <summary>
        /// Gets the convention-based authorization filter name (without the schema), constructed by sorting the specified
        ...
        public static string GetAuthorizationFilterName(string endpoint1, string endpoint2, string authorizationPathModifier)
        {
