...
namespace EdFi.Ods.Api.Security.AuthorizationStrategies.Relationships
{
    ...
    public interface IRelationshipsAuthorizationContextDataProvider<in TAbstractModel>
        : IRelationshipsAuthorizationContextDataProvider
    {
        ...
        RelationshipsAuthorizationContextData GetContextData(TAbstractModel resource);
    }
    ...
    /// </remarks>
    public interface IRelationshipsAuthorizationContextDataProvider
    {
        /// <summary>
        /// Gets the Ed-Fi authorization context data to be used in an authorization decision.
        /// </summary>
        /// <param name="resource">The resource model from which authorization context data is to be derived.</param>
        /// <returns>The authorization context data.</returns>
        RelationshipsAuthorizationContextData GetContextData(object resource);
