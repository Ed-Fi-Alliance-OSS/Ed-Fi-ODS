...
namespace EdFi.Ods.Api.Extensibility
{
    public class ExtensionNHibernateConfigurationProvider : IExtensionNHibernateConfigurationProvider
    {
        ...
        {
            return _domainModel.Entities.Where(e => e.IsEntityExtension && e.Schema.Equals(PhysicalName))
                .Select(
                    e => new
                    {
        ...
        {
            return _domainModel.Entities
                .Where(e => e.IsDerived && e.IsExtensionEntity && e.Schema.Equals(PhysicalName) && e.IsDescriptorEntity)
                .Select(
                    e => new
                    {
            ...
            HbmJoinedSubclass CreateHbmJoinSubclass(Entity entity)
            {
                ...
                var references = entity.NavigableOneToOnes.Select(CreateHbmBag).ToArray<object>();
        ...
        private Dictionary<string, HbmSubclass[]> CreateDiscriminatorBasedHbmSubclassesByEntityName()
        {
            return _domainModel.Entities
                .Where(
                    e => e.IsDerived && e.IsExtensionEntity && e.Schema.Equals(PhysicalName) &&
                         !e.BaseEntity.Schema.Equals(PhysicalName) && !e.IsDescriptorEntity)
                .Select(
                    e => new
                    {
                        EntityName = !e.BaseEntity.IsAbstract
            ...
            {
                var properties = GetRenamedIdentifyingProperties()
                ...
                var collections = entity.NavigableChildren
