...
namespace EdFi.Ods.WebService.Tests
{
    internal class UriHelper
    {
        ...
        private const string UriWithoutSchema = TestConstants.YearSpecificBaseUrl + "{0}/v{1}/{2}{3}";
        private const string UriWithSchema = TestConstants.YearSpecificBaseUrl + "{0}/v{1}/{2}/{3}{4}";
        private const string UriWithSchoolYear = TestConstants.YearSpecificBaseUrl + "{0}/v{1}/{2}{3}/{4}{5}";
        private const string UriDependenciesWithoutSchema = TestConstants.YearSpecificBaseUrl + "metadata/{0}/v{1}/{2}{3}";
        private const string UriDependenciesWithSchema = TestConstants.YearSpecificBaseUrl + "metadata/{0}/v{1}/{2}/{3}{4}";
        private const string UriDependenciesWithSchoolYear = TestConstants.YearSpecificBaseUrl + "metadata/{0}/v{1}/{2}{3}/{4}{5}";
