...
IF NOT EXISTS(SELECT 1 FROM [dbo].[AuthorizationStrategies] WHERE [AuthorizationStrategyName] ='RelationshipsWithStudentsOnlyThroughEdOrgAssociation')
BEGIN
    INSERT INTO [dbo].[AuthorizationStrategies] ([DisplayName], [AuthorizationStrategyName], [Application_ApplicationId])
...
ELSE
BEGIN
    SELECT @typesResourceClaimId = ResourceClaimID FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/edFiTypes' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @systemDescriptorsResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/systemDescriptors' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @managedDescriptorsResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/managedDescriptors' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @educationOrganizationsResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/educationOrganizations' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @peopleResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/people' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @relationshipBasedDataResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/relationshipBasedData' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @assessmentMetadataResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/assessmentMetadata' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @identityResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/identity' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @educationStandardsResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/educationStandards' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @primaryRelationshipsResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/primaryRelationships' AND Application_ApplicationId = @applicationId
END
...
ELSE
BEGIN
    SELECT @surveyDomainResourceClaimId = ResourceClaimId FROM [dbo].[ResourceClaims] WHERE [ClaimName] ='http://ed-fi.org/ods/identity/claims/domains/surveyDomain' AND Application_ApplicationId = @applicationId
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'assignmentLateStatusDescriptor', N'assignmentLateStatusDescriptor', N'http://ed-fi.org/ods/identity/claims/assignmentLateStatusDescriptor', @systemDescriptorsResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'balanceSheetDimension', N'balanceSheetDimension', N'http://ed-fi.org/ods/identity/claims/balanceSheetDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'chartOfAccount', N'chartOfAccount', N'http://ed-fi.org/ods/identity/claims/chartOfAccount', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'descriptorMapping', N'descriptorMapping', N'http://ed-fi.org/ods/identity/claims/descriptorMapping', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'functionDimension', N'functionDimension', N'http://ed-fi.org/ods/identity/claims/functionDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localAccount', N'localAccount', N'http://ed-fi.org/ods/identity/claims/localAccount', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localActual', N'localActual', N'http://ed-fi.org/ods/identity/claims/localActual', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localBudget', N'localBudget', N'http://ed-fi.org/ods/identity/claims/localBudget', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localContractedStaff', N'localContractedStaff', N'http://ed-fi.org/ods/identity/claims/localContractedStaff', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localEncumbrance', N'localEncumbrance', N'http://ed-fi.org/ods/identity/claims/localEncumbrance', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'localPayroll', N'localPayroll', N'http://ed-fi.org/ods/identity/claims/localPayroll', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'modelEntityDescriptor', N'modelEntityDescriptor', N'http://ed-fi.org/ods/identity/claims/modelEntityDescriptor', @systemDescriptorsResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'objectDimension', N'objectDimension', N'http://ed-fi.org/ods/identity/claims/objectDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'operationalUnitDimension', N'operationalUnitDimension', N'http://ed-fi.org/ods/identity/claims/operationalUnitDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'programDimension', N'programDimension', N'http://ed-fi.org/ods/identity/claims/programDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'projectDimension', N'projectDimension', N'http://ed-fi.org/ods/identity/claims/projectDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'reportingTagDescriptor', N'reportingTagDescriptor', N'http://ed-fi.org/ods/identity/claims/reportingTagDescriptor', @systemDescriptorsResourceClaimId, @applicationId);
END
...
BEGIN
INSERT [dbo].[ResourceClaims] ([DisplayName], [ResourceName], [ClaimName], [ParentResourceClaimId], [Application_ApplicationId])
VALUES (N'sourceDimension', N'sourceDimension', N'http://ed-fi.org/ods/identity/claims/sourceDimension', @relationshipBasedDataResourceClaimId, @applicationId);
END
...
FROM
(
SELECT ac.ActionId, @ClaimSetId AS ClaimSetId, ResourceClaimId, null AS [ValidationRuleSetNameOverride]
...
WHERE NOT EXISTS (SELECT 1 FROM ClaimSetResourceClaimActions WHERE [ActionId] = result.[ActionId] AND ClaimSetId = result.ClaimSetId AND ResourceClaimId = result.ResourceClaimId);
...
WHERE NOT EXISTS (SELECT 1 FROM [ResourceClaimActions] WHERE [ActionId] = result.[ActionId] AND ResourceClaimId = result.ResourceClaimId);
...
FROM
(
SELECT RCAA.ResourceClaimActionId,@AuthorizationStrategyId AS AuthorizationStrategyId
...
WHERE NOT EXISTS (SELECT 1 FROM ResourceClaimActionAuthorizationStrategies WHERE ResourceClaimActionId = result.ResourceClaimActionId AND AuthorizationStrategyId = result.AuthorizationStrategyId)
...
DELETE RCAS
FROM ResourceClaimActionAuthorizationStrategies RCAS
...
AND NOT EXISTS (SELECT 1 FROM [ClaimSetResourceClaimActionAuthorizationStrategyOverrides] WHERE [ClaimSetResourceClaimActionId] = CSRCAA.ClaimSetResourceClaimActionId AND AuthorizationStrategyId = @AuthorizationStrategyId)